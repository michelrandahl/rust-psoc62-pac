...
pub type R = crate::R<HOST_EP1_STATUS_SPEC>;
...
#[doc = "Host Endpoint 1 Status Register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`host_ep1_status::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
