...
pub type R = crate::R<ARB_RW3_DR16_SPEC>;
#[doc = "Register `ARB_RW3_DR16` writer"]
pub type W = crate::W<ARB_RW3_DR16_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dr16(&mut self) -> DR16_W<ARB_RW3_DR16_SPEC> {
        DR16_W::new(self, 0)
    }
...
#[doc = "Endpoint Data Register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`arb_rw3_dr16::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`arb_rw3_dr16::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
