...
pub type R = crate::R<MONITOR_CTL_0_SPEC>;
#[doc = "Register `MONITOR_CTL_0` writer"]
pub type W = crate::W<MONITOR_CTL_0_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn monitor_en(&mut self) -> MONITOR_EN_W<MONITOR_CTL_0_SPEC> {
...
#[doc = "Power/Ground Monitor cell control 0\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`monitor_ctl_0::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`monitor_ctl_0::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
