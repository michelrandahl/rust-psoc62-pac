...
pub type R = crate::R<ARB_RW8_DR16_SPEC>;
#[doc = "Register `ARB_RW8_DR16` writer"]
pub type W = crate::W<ARB_RW8_DR16_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dr16(&mut self) -> DR16_W<ARB_RW8_DR16_SPEC> {
        DR16_W::new(self, 0)
    }
