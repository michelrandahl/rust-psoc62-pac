...
pub type R = crate::R<CM0_PC0_HANDLER_SPEC>;
#[doc = "Register `CM0_PC0_HANDLER` writer"]
pub type W = crate::W<CM0_PC0_HANDLER_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn addr(&mut self) -> ADDR_W<CM0_PC0_HANDLER_SPEC> {
        ADDR_W::new(self, 0)
    }
...
#[doc = "CM0+ protection context 0 handler\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`cm0_pc0_handler::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`cm0_pc0_handler::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
