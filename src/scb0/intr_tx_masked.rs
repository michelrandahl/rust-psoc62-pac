...
pub type R = crate::R<INTR_TX_MASKED_SPEC>;
...
#[doc = "Transmitter interrupt masked request\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`intr_tx_masked::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
