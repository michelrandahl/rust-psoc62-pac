...
pub type R = crate::R<CRYPTO_OUTPUT1_SPEC>;
#[doc = "Register `CRYPTO_OUTPUT1` writer"]
pub type W = crate::W<CRYPTO_OUTPUT1_SPEC>;
...
= CRYPTO_OUTPUT1.OUTPUT\\[31:0\\]."]
    #[inline(always)]
    #[must_use]
    pub fn output(&mut self) -> OUTPUT_W<CRYPTO_OUTPUT1_SPEC> {
        OUTPUT_W::new(self, 0)
    }
