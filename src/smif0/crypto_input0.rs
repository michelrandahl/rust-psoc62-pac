...
pub type R = crate::R<CRYPTO_INPUT0_SPEC>;
#[doc = "Register `CRYPTO_INPUT0` writer"]
pub type W = crate::W<CRYPTO_INPUT0_SPEC>;
...
= CRYPTO_INPUT0.INPUT\\[31:0\\]."]
    #[inline(always)]
    #[must_use]
    pub fn input(&mut self) -> INPUT_W<CRYPTO_INPUT0_SPEC> {
        INPUT_W::new(self, 0)
    }
