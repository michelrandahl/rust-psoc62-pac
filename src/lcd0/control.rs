...
impl LCD_MODE_R {
    ...
    #[inline(always)]
    pub const fn variant(&self) -> LCD_MODE_A {
        match self.bits {
            false => LCD_MODE_A::LS,
            true => LCD_MODE_A::HS,
        }
...
pub type LCD_MODE_W<'a, REG> = crate::BitWriter<'a, REG, LCD_MODE_A>;
impl<'a, REG> LCD_MODE_W<'a, REG>
where
...
pub type TYPE_W<'a, REG> = crate::BitWriter<'a, REG, TYPE_A>;
...
impl OP_MODE_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> OP_MODE_A {
        match self.bits {
            false => OP_MODE_A::PWM,
...
pub type OP_MODE_W<'a, REG> = crate::BitWriter<'a, REG, OP_MODE_A>;
impl<'a, REG> OP_MODE_W<'a, REG>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    #[doc = "PWM Mode"]
...
pub type COM_NUM_W<'a, REG> = crate::FieldWriter<'a, REG, 4>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ls_en(&mut self) -> LS_EN_W<CONTROL_SPEC> {
        LS_EN_W::new(self, 0)
    }
    #[doc = "Bit 1 - High speed (HS) generator enable 1: enable 0: disable"]
    #[inline(always)]
    #[must_use]
    pub fn hs_en(&mut self) -> HS_EN_W<CONTROL_SPEC> {
        HS_EN_W::new(self, 1)
    }
    #[doc = "Bit 2 - HS/LS Mode selection"]
    #[inline(always)]
    #[must_use]
    pub fn lcd_mode(&mut self) -> LCD_MODE_W<CONTROL_SPEC> {
        LCD_MODE_W::new(self, 2)
    }
    #[doc = "Bit 3 - LCD driving waveform type configuration."]
    #[inline(always)]
    #[must_use]
    pub fn type_(&mut self) -> TYPE_W<CONTROL_SPEC> {
        TYPE_W::new(self, 3)
    }
    #[doc = "Bit 4 - Driving mode configuration"]
    #[inline(always)]
    #[must_use]
    pub fn op_mode(&mut self) -> OP_MODE_W<CONTROL_SPEC> {
        OP_MODE_W::new(self, 4)
    }
    #[doc = "Bits 5:6 - PWM bias selection"]
    #[inline(always)]
    #[must_use]
    pub fn bias(&mut self) -> BIAS_W<CONTROL_SPEC> {
        BIAS_W::new(self, 5)
    }
    #[doc = "Bits 8:11 - The number of COM connections minus 2. So: 0: 2 COM's 1: 3 COM's ... 13: 15 COM's 14: 16 COM's 15: undefined"]
    #[inline(always)]
    #[must_use]
    pub fn com_num(&mut self) -> COM_NUM_W<CONTROL_SPEC> {
        COM_NUM_W::new(self, 8)
    }
