...
pub type R = crate::R<ACT_DESCR_DST_SPEC>;
...
#[doc = "Active descriptor destination\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`act_descr_dst::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
