...
pub type R = crate::R<CM0_CA_CTL1_SPEC>;
#[doc = "Register `CM0_CA_CTL1` writer"]
pub type W = crate::W<CM0_CA_CTL1_SPEC>;
#[doc = "Field `PWR_MODE` reader - Specifies power mode for CM0 cache."]
pub type PWR_MODE_R = crate::FieldReader<PWR_MODE_A>;
#[doc = "Specifies power mode for CM0 cache.\n\nValue on reset: 3"]
...
#[doc = "Field `PWR_MODE` writer - Specifies power mode for CM0 cache."]
...
impl R {
    #[doc = "Bits 0:1 - Specifies power mode for CM0 cache."]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pwr_mode(&mut self) -> PWR_MODE_W<CM0_CA_CTL1_SPEC> {
...
#[doc = "CM0+ cache control\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`cm0_ca_ctl1::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`cm0_ca_ctl1::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
