...
pub type R = crate::R<RAM2_PWR_CTL_SPEC>;
#[doc = "Register `RAM2_PWR_CTL` writer"]
pub type W = crate::W<RAM2_PWR_CTL_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pwr_mode(&mut self) -> PWR_MODE_W<RAM2_PWR_CTL_SPEC> {
...
#[doc = "RAM 2 power control\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ram2_pwr_ctl::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ram2_pwr_ctl::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
