...
pub type R = crate::R<GEOMETRY_SPEC>;
...
#[doc = "Regular flash geometry\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`geometry::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
