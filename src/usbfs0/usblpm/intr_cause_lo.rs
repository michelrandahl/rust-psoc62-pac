...
pub type R = crate::R<INTR_CAUSE_LO_SPEC>;
...
#[doc = "Low priority interrupt Cause register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`intr_cause_lo::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
