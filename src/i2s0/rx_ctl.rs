...
pub type R = crate::R<RX_CTL_SPEC>;
#[doc = "Register `RX_CTL` writer"]
pub type W = crate::W<RX_CTL_SPEC>;
...
impl B_CLOCK_INV_R {
    ...
    #[inline(always)]
    pub const fn variant(&self) -> B_CLOCK_INV_A {
        match self.bits {
...
pub type B_CLOCK_INV_W<'a, REG> = crate::BitWriter<'a, REG, B_CLOCK_INV_A>;
impl<'a, REG> B_CLOCK_INV_W<'a, REG>
where
...
impl CH_NR_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> CH_NR_A {
        match self.bits {
            0 => CH_NR_A::CH_NUM1,
            1 => CH_NR_A::CH_NUM2,
            2 => CH_NR_A::CH_NUM3,
...
pub type CH_NR_W<'a, REG> = crate::FieldWriterSafe<'a, REG, 3, CH_NR_A>;
impl<'a, REG> CH_NR_W<'a, REG>
where
    REG: crate::Writable + crate::RegisterSpec,
    REG::Ux: From<u8>,
{
...
pub type MS_W<'a, REG> = crate::BitWriter<'a, REG, MS_A>;
impl<'a, REG> MS_W<'a, REG>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    #[doc = "Slave"]
...
impl I2S_MODE_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> I2S_MODE_A {
        match self.bits {
...
pub type I2S_MODE_W<'a, REG> = crate::FieldWriterSafe<'a, REG, 2, I2S_MODE_A>;
impl<'a, REG> I2S_MODE_W<'a, REG>
where
    REG: crate::Writable + crate::RegisterSpec,
    REG::Ux: From<u8>,
{
...
impl WS_PULSE_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> WS_PULSE_A {
        match self.bits {
...
pub type WS_PULSE_W<'a, REG> = crate::BitWriter<'a, REG, WS_PULSE_A>;
impl<'a, REG> WS_PULSE_W<'a, REG>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    #[doc = "Pulse width is 1 SCK period"]
...
pub type WD_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
...
impl CH_LEN_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> Option<CH_LEN_A> {
        match self.bits {
...
pub type CH_LEN_W<'a, REG> = crate::FieldWriter<'a, REG, 3, CH_LEN_A>;
impl<'a, REG> CH_LEN_W<'a, REG>
where
    REG: crate::Writable + crate::RegisterSpec,
    REG::Ux: From<u8>,
{
...
impl WORD_LEN_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> Option<WORD_LEN_A> {
        match self.bits {
...
pub type WORD_LEN_W<'a, REG> = crate::FieldWriter<'a, REG, 3, WORD_LEN_A>;
...
pub type SCKO_POL_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type SCKI_POL_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn b_clock_inv(&mut self) -> B_CLOCK_INV_W<RX_CTL_SPEC> {
        B_CLOCK_INV_W::new(self, 3)
    }
    #[doc = "Bits 4:6 - Specifies number of channels per frame: Note: only '2channels' is supported during Left Justfied or I2S mode. Hence software must set '1' to this field in the modes. (Note: These bits are connected to AR38U12.RX_CFG.RX_CHSET)"]
    #[inline(always)]
    #[must_use]
    pub fn ch_nr(&mut self) -> CH_NR_W<RX_CTL_SPEC> {
        CH_NR_W::new(self, 4)
    }
    #[doc = "Bit 7 - Set interface in master or slave mode: (Note: This bit is connected to AR38U12.TX_CFG.RX_MS)"]
    #[inline(always)]
    #[must_use]
    pub fn ms(&mut self) -> MS_W<RX_CTL_SPEC> {
        MS_W::new(self, 7)
    }
    #[doc = "Bits 8:9 - Select I2S, left-justified or TDM: (Note: These bits are connected to AR38U12.RX_CFG.RX_I2S_MODE)"]
    #[inline(always)]
    #[must_use]
    pub fn i2s_mode(&mut self) -> I2S_MODE_W<RX_CTL_SPEC> {
        I2S_MODE_W::new(self, 8)
    }
    #[doc = "Bit 10 - Set WS pulse width in TDM mode: (Note: This bit is connected to AR38U12.RX_CFG.RX_WS_PULSE) Note: When not TDM mode, must be '1'."]
    #[inline(always)]
    #[must_use]
    pub fn ws_pulse(&mut self) -> WS_PULSE_W<RX_CTL_SPEC> {
        WS_PULSE_W::new(self, 10)
    }
    #[doc = "Bit 13 - Set watchdog for 'rx_ws_in' '0': Disabled. '1': Enabled."]
    #[inline(always)]
    #[must_use]
    pub fn wd_en(&mut self) -> WD_EN_W<RX_CTL_SPEC> {
        WD_EN_W::new(self, 13)
    }
    #[doc = "Bits 16:18 - Channel length in number of bits: Note: - When this field is configured to '6' or '7', the length is set to 32-bit (same as '5'). - When TDM mode, must be 32-bit length to this field. (Note: These bits are connected to AR38U12.RX_CFG.RX_CHLEN)"]
    #[inline(always)]
    #[must_use]
    pub fn ch_len(&mut self) -> CH_LEN_W<RX_CTL_SPEC> {
        CH_LEN_W::new(self, 16)
    }
    #[doc = "Bits 20:22 - Word length in number of bits: Note: - When this field is configured to '6' or '7', the length is set to 32-bit (same as '5'). - Don't configure this field as beyond Channel length. (Note: These bits are connected to AR38U12.RX_CFG.RX_IWL)"]
    #[inline(always)]
    #[must_use]
    pub fn word_len(&mut self) -> WORD_LEN_W<RX_CTL_SPEC> {
        WORD_LEN_W::new(self, 20)
    }
    #[doc = "Bit 23 - When reception word length is shorter than the word length of RX_FIFO_RD, extension mode of upper bit should be set. '0': Extended by '0' '1': Extended by sign bit (if MSB word is '1', then it is extended by '1', if MSB is '0' then it is extended by '0')"]
    #[inline(always)]
    #[must_use]
    pub fn bit_extension(&mut self) -> BIT_EXTENSION_W<RX_CTL_SPEC> {
        BIT_EXTENSION_W::new(self, 23)
    }
    #[doc = "Bit 24 - RX master bit clock polarity. When this bit is 1, the outgoing rx_sck signal is inverted after it has been transmitted from the I2S receiver core. This bit does not affect the internal serial data capture timing. The word sync (RX_WS) signal is not affected by this bit setting.See RX_CTL.B_CLOCK_INV for more details."]
    #[inline(always)]
    #[must_use]
    pub fn scko_pol(&mut self) -> SCKO_POL_W<RX_CTL_SPEC> {
        SCKO_POL_W::new(self, 24)
    }
    #[doc = "Bit 25 - RX slave bit clock polarity. When this bit is 1, the incoming rx_sck signal is inverted before it is received by the I2S receiver core. This bit does not affect the internal serial data capture timing. The word sync (RX_WS) signal is not affected by this bit setting. '0': When receiver is in slave mode, serial data is sampled on the rising bit clock edge '1': When receiver is in slave mode, serial data is sampled on the falling bit clock edge"]
    #[inline(always)]
    #[must_use]
    pub fn scki_pol(&mut self) -> SCKI_POL_W<RX_CTL_SPEC> {
        SCKI_POL_W::new(self, 25)
    }
...
#[doc = "Receiver control\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`rx_ctl::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`rx_ctl::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
