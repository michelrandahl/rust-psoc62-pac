...
impl PWR_CTRL_VREF_R {
    ...
    #[inline(always)]
    pub const fn variant(&self) -> PWR_CTRL_VREF_A {
        match self.bits {
...
pub type PWR_CTRL_VREF_W<'a, REG> = crate::FieldWriterSafe<'a, REG, 3, PWR_CTRL_VREF_A>;
impl<'a, REG> PWR_CTRL_VREF_W<'a, REG>
where
...
impl VREF_SEL_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> VREF_SEL_A {
        match self.bits {
            0 => VREF_SEL_A::VREF0,
            1 => VREF_SEL_A::VREF1,
            2 => VREF_SEL_A::VREF2,
...
pub type VREF_SEL_W<'a, REG> = crate::FieldWriterSafe<'a, REG, 3, VREF_SEL_A>;
impl<'a, REG> VREF_SEL_W<'a, REG>
where
    REG: crate::Writable + crate::RegisterSpec,
    REG::Ux: From<u8>,
{
...
pub type VREF_BYP_CAP_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
...
impl NEG_SEL_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> NEG_SEL_A {
        match self.bits {
...
pub type NEG_SEL_W<'a, REG> = crate::FieldWriterSafe<'a, REG, 3, NEG_SEL_A>;
impl<'a, REG> NEG_SEL_W<'a, REG>
where
    REG: crate::Writable + crate::RegisterSpec,
    REG::Ux: From<u8>,
{
...
pub type SAR_HW_CTRL_NEGVREF_W<'a, REG> = crate::BitWriter<'a, REG>;
...
impl COMP_DLY_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> COMP_DLY_A {
        match self.bits {
            0 => COMP_DLY_A::D2P5,
            1 => COMP_DLY_A::D4,
            2 => COMP_DLY_A::D10,
...
pub type COMP_DLY_W<'a, REG> = crate::FieldWriterSafe<'a, REG, 2, COMP_DLY_A>;
impl<'a, REG> COMP_DLY_W<'a, REG>
where
    REG: crate::Writable + crate::RegisterSpec,
    REG::Ux: From<u8>,
{
...
pub type BOOSTPUMP_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type REFBUF_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
...
impl COMP_PWR_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> COMP_PWR_A {
        match self.bits {
            0 => COMP_PWR_A::P100,
            1 => COMP_PWR_A::P80,
            2 => COMP_PWR_A::P60,
...
pub type COMP_PWR_W<'a, REG> = crate::FieldWriterSafe<'a, REG, 3, COMP_PWR_A>;
impl<'a, REG> COMP_PWR_W<'a, REG>
where
    REG: crate::Writable + crate::RegisterSpec,
    REG::Ux: From<u8>,
{
...
pub type DEEPSLEEP_ON_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type DSI_SYNC_CONFIG_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type DSI_MODE_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type SWITCH_DISABLE_W<'a, REG> = crate::BitWriter<'a, REG>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pwr_ctrl_vref(&mut self) -> PWR_CTRL_VREF_W<CTRL_SPEC> {
        PWR_CTRL_VREF_W::new(self, 0)
    }
    #[doc = "Bits 4:6 - SARADC internal VREF selection."]
    #[inline(always)]
    #[must_use]
    pub fn vref_sel(&mut self) -> VREF_SEL_W<CTRL_SPEC> {
        VREF_SEL_W::new(self, 4)
    }
    #[doc = "Bit 7 - VREF bypass cap enable for when VREF buffer is on"]
    #[inline(always)]
    #[must_use]
    pub fn vref_byp_cap_en(&mut self) -> VREF_BYP_CAP_EN_W<CTRL_SPEC> {
        VREF_BYP_CAP_EN_W::new(self, 7)
    }
    #[doc = "Bits 9:11 - SARADC internal NEG selection for Single ended conversion"]
    #[inline(always)]
    #[must_use]
    pub fn neg_sel(&mut self) -> NEG_SEL_W<CTRL_SPEC> {
        NEG_SEL_W::new(self, 9)
    }
    #[doc = "Bit 13 - Hardware control: 0=only firmware control, 1=hardware control masked by firmware setting for VREF to NEG switch."]
    #[inline(always)]
    #[must_use]
    pub fn sar_hw_ctrl_negvref(&mut self) -> SAR_HW_CTRL_NEGVREF_W<CTRL_SPEC> {
        SAR_HW_CTRL_NEGVREF_W::new(self, 13)
    }
    #[doc = "Bits 14:15 - Set the comparator latch delay in accordance with SAR conversion rate"]
    #[inline(always)]
    #[must_use]
    pub fn comp_dly(&mut self) -> COMP_DLY_W<CTRL_SPEC> {
        COMP_DLY_W::new(self, 14)
    }
    #[doc = "Bits 16:19 - Spare controls, not yet designated, for late changes done with an ECO"]
    #[inline(always)]
    #[must_use]
    ...
    #[inline(always)]
    #[must_use]
    pub fn boostpump_en(&mut self) -> BOOSTPUMP_EN_W<CTRL_SPEC> {
        BOOSTPUMP_EN_W::new(self, 20)
    }
    #[doc = "Bit 21 - For normal ADC operation this bit must be set, for all reference choices - internal, external or vdda based reference. Setting this bit is critical to proper function of switches inside SARREF block."]
    #[inline(always)]
    #[must_use]
    pub fn refbuf_en(&mut self) -> REFBUF_EN_W<CTRL_SPEC> {
        REFBUF_EN_W::new(self, 21)
    }
    #[doc = "Bits 24:26 - Comparator power mode. (Sample rate TBD)"]
    #[inline(always)]
    #[must_use]
    pub fn comp_pwr(&mut self) -> COMP_PWR_W<CTRL_SPEC> {
        COMP_PWR_W::new(self, 24)
    }
    #[doc = "Bit 27 - - 0: SARMUX IP disabled off during DeepSleep power mode - 1: SARMUX IP remains enabled during DeepSleep power mode (if ENABLED=1)"]
    #[inline(always)]
    #[must_use]
    pub fn deepsleep_on(&mut self) -> DEEPSLEEP_ON_W<CTRL_SPEC> {
        DEEPSLEEP_ON_W::new(self, 27)
    }
    #[doc = "Bit 28 - - 0: bypass clock domain synchronization of the DSI config signals. - 1: synchronize the DSI config signals to peripheral clock domain."]
    #[inline(always)]
    #[must_use]
    pub fn dsi_sync_config(&mut self) -> DSI_SYNC_CONFIG_W<CTRL_SPEC> {
        DSI_SYNC_CONFIG_W::new(self, 28)
    }
    #[doc = "Bit 29 - SAR sequencer takes configuration from DSI signals (note this also has the same effect as SWITCH_DISABLE==1) - 0: Normal mode, SAR sequencer operates according to CHAN_EN enables and CHAN_CONFIG channel configurations - 1: CHAN_EN, INJ_START_EN and channel configurations in CHAN_CONFIG and INJ_CHAN_CONFIG are ignored"]
    #[inline(always)]
    #[must_use]
    pub fn dsi_mode(&mut self) -> DSI_MODE_W<CTRL_SPEC> {
        DSI_MODE_W::new(self, 29)
    }
    #[doc = "Bit 30 - Disable SAR sequencer from enabling routing switches (note DSI and firmware can always close switches independent of this control) - 0: Normal mode, SAR sequencer changes switches according to pin address in channel configurations - 1: Switches disabled, SAR sequencer does not enable any switches, it is the responsibility of the firmware or UDBs (through DSI) to set the switches to route the signal to be converted through the SARMUX"]
    #[inline(always)]
    #[must_use]
    pub fn switch_disable(&mut self) -> SWITCH_DISABLE_W<CTRL_SPEC> {
        SWITCH_DISABLE_W::new(self, 30)
    }
    #[doc = "Bit 31 - - 0: SAR IP disabled (put analog in power down and stop clocks), also can clear FW_TRIGGER and INJ_START_EN (if not tailgating) on write. - 1: SAR IP enabled."]
    #[inline(always)]
    #[must_use]
