...
pub type R = crate::R<SRAM_DATA1_SPEC>;
#[doc = "Register `SRAM_DATA1` writer"]
pub type W = crate::W<SRAM_DATA1_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn data(&mut self) -> DATA_W<SRAM_DATA1_SPEC> {
        DATA_W::new(self, 0)
    }
...
#[doc = "SRAM data 1\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`sram_data1::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`sram_data1::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
