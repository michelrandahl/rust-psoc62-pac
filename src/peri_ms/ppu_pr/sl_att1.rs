...
pub type R = crate::R<SL_ATT1_SPEC>;
#[doc = "Register `SL_ATT1` writer"]
pub type W = crate::W<SL_ATT1_SPEC>;
...
pub type PC4_UR_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type PC4_PR_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type PC5_UR_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type PC5_PR_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type PC6_UR_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type PC6_PR_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type PC7_UR_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type PC7_PR_W<'a, REG> = crate::BitWriter<'a, REG>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pc4_ur(&mut self) -> PC4_UR_W<SL_ATT1_SPEC> {
        PC4_UR_W::new(self, 0)
    }
    #[doc = "Bit 1 - Protection context 4, user write enable."]
    #[inline(always)]
    #[must_use]
    pub fn pc4_uw(&mut self) -> PC4_UW_W<SL_ATT1_SPEC> {
        PC4_UW_W::new(self, 1)
    }
    #[doc = "Bit 2 - Protection context 4, privileged read enable."]
    #[inline(always)]
    #[must_use]
    pub fn pc4_pr(&mut self) -> PC4_PR_W<SL_ATT1_SPEC> {
        PC4_PR_W::new(self, 2)
    }
    #[doc = "Bit 3 - Protection context 4, privileged write enable."]
    #[inline(always)]
    #[must_use]
    pub fn pc4_pw(&mut self) -> PC4_PW_W<SL_ATT1_SPEC> {
        PC4_PW_W::new(self, 3)
    }
    #[doc = "Bit 4 - Protection context 4, non-secure."]
    #[inline(always)]
    #[must_use]
    pub fn pc4_ns(&mut self) -> PC4_NS_W<SL_ATT1_SPEC> {
        PC4_NS_W::new(self, 4)
    }
    #[doc = "Bit 8 - Protection context 5, user read enable."]
    #[inline(always)]
    #[must_use]
    pub fn pc5_ur(&mut self) -> PC5_UR_W<SL_ATT1_SPEC> {
        PC5_UR_W::new(self, 8)
    }
    #[doc = "Bit 9 - Protection context 5, user write enable."]
    #[inline(always)]
    #[must_use]
    pub fn pc5_uw(&mut self) -> PC5_UW_W<SL_ATT1_SPEC> {
        PC5_UW_W::new(self, 9)
    }
    #[doc = "Bit 10 - Protection context 5, privileged read enable."]
    #[inline(always)]
    #[must_use]
    pub fn pc5_pr(&mut self) -> PC5_PR_W<SL_ATT1_SPEC> {
        PC5_PR_W::new(self, 10)
    }
    #[doc = "Bit 11 - Protection context 5, privileged write enable."]
    #[inline(always)]
    #[must_use]
    pub fn pc5_pw(&mut self) -> PC5_PW_W<SL_ATT1_SPEC> {
        PC5_PW_W::new(self, 11)
    }
    #[doc = "Bit 12 - Protection context 5, non-secure."]
    #[inline(always)]
    #[must_use]
    pub fn pc5_ns(&mut self) -> PC5_NS_W<SL_ATT1_SPEC> {
        PC5_NS_W::new(self, 12)
    }
    #[doc = "Bit 16 - Protection context 6, user read enable."]
    #[inline(always)]
    #[must_use]
    pub fn pc6_ur(&mut self) -> PC6_UR_W<SL_ATT1_SPEC> {
        PC6_UR_W::new(self, 16)
    }
    #[doc = "Bit 17 - Protection context 6, user write enable."]
    #[inline(always)]
    #[must_use]
    pub fn pc6_uw(&mut self) -> PC6_UW_W<SL_ATT1_SPEC> {
        PC6_UW_W::new(self, 17)
    }
    #[doc = "Bit 18 - Protection context 6, privileged read enable."]
    #[inline(always)]
    #[must_use]
    pub fn pc6_pr(&mut self) -> PC6_PR_W<SL_ATT1_SPEC> {
        PC6_PR_W::new(self, 18)
    }
    #[doc = "Bit 19 - Protection context 6, privileged write enable."]
    #[inline(always)]
    #[must_use]
    pub fn pc6_pw(&mut self) -> PC6_PW_W<SL_ATT1_SPEC> {
        PC6_PW_W::new(self, 19)
    }
    #[doc = "Bit 20 - Protection context 6, non-secure."]
    #[inline(always)]
    #[must_use]
    pub fn pc6_ns(&mut self) -> PC6_NS_W<SL_ATT1_SPEC> {
        PC6_NS_W::new(self, 20)
    }
    #[doc = "Bit 24 - Protection context 7, user read enable."]
    #[inline(always)]
    #[must_use]
    pub fn pc7_ur(&mut self) -> PC7_UR_W<SL_ATT1_SPEC> {
        PC7_UR_W::new(self, 24)
    }
    #[doc = "Bit 25 - Protection context 7, user write enable."]
    #[inline(always)]
    #[must_use]
    pub fn pc7_uw(&mut self) -> PC7_UW_W<SL_ATT1_SPEC> {
        PC7_UW_W::new(self, 25)
    }
    #[doc = "Bit 26 - Protection context 7, privileged read enable."]
    #[inline(always)]
    #[must_use]
    pub fn pc7_pr(&mut self) -> PC7_PR_W<SL_ATT1_SPEC> {
        PC7_PR_W::new(self, 26)
    }
    #[doc = "Bit 27 - Protection context 7, privileged write enable."]
    #[inline(always)]
    #[must_use]
    pub fn pc7_pw(&mut self) -> PC7_PW_W<SL_ATT1_SPEC> {
        PC7_PW_W::new(self, 27)
    }
    #[doc = "Bit 28 - Protection context 7, non-secure."]
    #[inline(always)]
    #[must_use]
    pub fn pc7_ns(&mut self) -> PC7_NS_W<SL_ATT1_SPEC> {
...
#[doc = "Slave attributes 1\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`sl_att1::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`sl_att1::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
