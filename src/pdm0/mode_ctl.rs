...
pub type R = crate::R<MODE_CTL_SPEC>;
#[doc = "Register `MODE_CTL` writer"]
pub type W = crate::W<MODE_CTL_SPEC>;
...
impl PCM_CH_SET_R {
    ...
    #[inline(always)]
    pub const fn variant(&self) -> PCM_CH_SET_A {
        match self.bits {
...
pub type PCM_CH_SET_W<'a, REG> = crate::FieldWriterSafe<'a, REG, 2, PCM_CH_SET_A>;
impl<'a, REG> PCM_CH_SET_W<'a, REG>
where
...
pub type SWAP_LR_W<'a, REG> = crate::BitWriter<'a, REG>;
...
impl S_CYCLES_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> S_CYCLES_A {
        match self.bits {
...
pub type S_CYCLES_W<'a, REG> = crate::FieldWriterSafe<'a, REG, 3, S_CYCLES_A>;
impl<'a, REG> S_CYCLES_W<'a, REG>
where
    REG: crate::Writable + crate::RegisterSpec,
    REG::Ux: From<u8>,
{
...
impl CKO_DELAY_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> CKO_DELAY_A {
        match self.bits {
            0 => CKO_DELAY_A::ADV3,
            1 => CKO_DELAY_A::ADV2,
            2 => CKO_DELAY_A::ADV1,
...
pub type CKO_DELAY_W<'a, REG> = crate::FieldWriterSafe<'a, REG, 3, CKO_DELAY_A>;
impl<'a, REG> CKO_DELAY_W<'a, REG>
where
    REG: crate::Writable + crate::RegisterSpec,
    REG::Ux: From<u8>,
{
...
(Note: These bits are connected to AR36U12.PDM_CORE_CFG.HPGAIN)"]
pub type HPF_GAIN_W<'a, REG> = crate::FieldWriter<'a, REG, 4>;
...
pub type HPF_EN_N_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pcm_ch_set(&mut self) -> PCM_CH_SET_W<MODE_CTL_SPEC> {
        PCM_CH_SET_W::new(self, 0)
    }
    #[doc = "Bit 2 - Input data L/R channel swap: '1': Right/Left channel recording swap '0': No Swap (Note: This bit is connected to AR36U12.PDM_CORE_CFG.LRSWAP)"]
    #[inline(always)]
    #[must_use]
    pub fn swap_lr(&mut self) -> SWAP_LR_W<MODE_CTL_SPEC> {
        SWAP_LR_W::new(self, 2)
    }
    #[doc = "Bits 8:10 - Set time step for gain change during PGA or soft mute operation in number of 1/a sampling rate. (Note: These bits are connected to AR36U12.PDM_CORE_CFG.S_CYCLES)"]
    #[inline(always)]
    #[must_use]
    pub fn s_cycles(&mut self) -> S_CYCLES_W<MODE_CTL_SPEC> {
        S_CYCLES_W::new(self, 8)
    }
    #[doc = "Bits 16:18 - Phase difference from the rising edge of internal sampler clock (CLK_IS) to that of PDM_CKO clock: (Note: These bits are connected to AR36U12.PDM_CORE2_CFG.PDMCKO_DLY)"]
    #[inline(always)]
    #[must_use]
    pub fn cko_delay(&mut self) -> CKO_DELAY_W<MODE_CTL_SPEC> {
        CKO_DELAY_W::new(self, 16)
    }
    #[doc = "Bits 24:27 - Adjust high pass filter coefficients. H(Z) = (1 - Z-1 ) / \\[1 - (1- 2 -HPF_GAIN) Z-1 \\]
(Note: These bits are connected to AR36U12.PDM_CORE_CFG.HPGAIN)"]
    #[inline(always)]
    #[must_use]
    pub fn hpf_gain(&mut self) -> HPF_GAIN_W<MODE_CTL_SPEC> {
        HPF_GAIN_W::new(self, 24)
    }
    #[doc = "Bit 28 - Enable high pass filter (active low) '1': Disabled. '0': Enabled. (Note: This bit is connected to AR36U12.PDM_CORE_CFG.ADCHPD)"]
    #[inline(always)]
    #[must_use]
    pub fn hpf_en_n(&mut self) -> HPF_EN_N_W<MODE_CTL_SPEC> {
        HPF_EN_N_W::new(self, 28)
    }
...
#[doc = "Mode control\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`mode_ctl::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`mode_ctl::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
