...
pub type R = crate::R<HOST_EP1_RW2_DR_SPEC>;
#[doc = "Register `HOST_EP1_RW2_DR` writer"]
pub type W = crate::W<HOST_EP1_RW2_DR_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn bfdt16(&mut self) -> BFDT16_W<HOST_EP1_RW2_DR_SPEC> {
        BFDT16_W::new(self, 0)
    }
...
#[doc = "Host Endpoint 1 Data 2-Byte Register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`host_ep1_rw2_dr::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`host_ep1_rw2_dr::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
