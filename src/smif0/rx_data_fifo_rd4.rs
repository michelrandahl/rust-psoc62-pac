...
pub type R = crate::R<RX_DATA_FIFO_RD4_SPEC>;
...
#[doc = "Receiver data FIFO read\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`rx_data_fifo_rd4::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
