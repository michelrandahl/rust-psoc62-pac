...
pub type R = crate::R<DW1_BUFF_CTL_SPEC>;
#[doc = "Register `DW1_BUFF_CTL` writer"]
pub type W = crate::W<DW1_BUFF_CTL_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pref_en(&mut self) -> PREF_EN_W<DW1_BUFF_CTL_SPEC> {
...
#[doc = "Datawire 1 buffer control\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`dw1_buff_ctl::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`dw1_buff_ctl::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
