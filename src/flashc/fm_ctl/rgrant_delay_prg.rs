...
pub type R = crate::R<RGRANT_DELAY_PRG_SPEC>;
#[doc = "Register `RGRANT_DELAY_PRG` writer"]
pub type W = crate::W<RGRANT_DELAY_PRG_SPEC>;
...
pub type RGRANT_DELAY_PRG_SEQ12_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
...
pub type RGRANT_DELAY_PRG_SEQ23_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
...
pub type RGRANT_DELAY_SEQ30_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
...
pub type RGRANT_DELAY_CLK_W<'a, REG> = crate::FieldWriter<'a, REG, 4>;
...
pub type HV_PARAMS_LOADED_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn rgrant_delay_prg_seq12(&mut self) -> RGRANT_DELAY_PRG_SEQ12_W<RGRANT_DELAY_PRG_SPEC> {
        RGRANT_DELAY_PRG_SEQ12_W::new(self, 0)
    }
    #[doc = "Bits 8:15 - PROG&amp;PRE_PROG: R-grant blocking delay on seq2-seq3 transition. Scale = ANA_CTL0.SCALE_SEQ23 When = 0 R_GRANT_DELAY control is disabled when IF_SEL=1 R_GRANT_DELAY control is disabled"]
    #[inline(always)]
    #[must_use]
    pub fn rgrant_delay_prg_seq23(&mut self) -> RGRANT_DELAY_PRG_SEQ23_W<RGRANT_DELAY_PRG_SPEC> {
        RGRANT_DELAY_PRG_SEQ23_W::new(self, 8)
    }
    #[doc = "Bits 16:23 - PROG&amp;PRE_PROG &amp; ERASE: R-grant blocking delay on seq3-seq0 transition. Scale = ANA_CTL0.SCALE_SEQ30 When = 0 R_GRANT_DELAY control is disabled when IF_SEL=1 R_GRANT_DELAY control is disabled"]
    #[inline(always)]
    #[must_use]
    pub fn rgrant_delay_seq30(&mut self) -> RGRANT_DELAY_SEQ30_W<RGRANT_DELAY_PRG_SPEC> {
        RGRANT_DELAY_SEQ30_W::new(self, 16)
    }
    #[doc = "Bits 24:27 - Frequency divider from clk_t to create the 8MHz reference clock for R_grant delay The value of this field is the integer result of 'clk_t frequency / 8'. Example: for clk_t=100 this field is INT(100/8) =12. This field is updated at runtime with the 'SW_RGRANT_DELAY_CLK ' value from the HV parameters table"]
    #[inline(always)]
    #[must_use]
    pub fn rgrant_delay_clk(&mut self) -> RGRANT_DELAY_CLK_W<RGRANT_DELAY_PRG_SPEC> {
        RGRANT_DELAY_CLK_W::new(self, 24)
    }
    #[doc = "Bit 31 - 0: HV Pulse common params not loaded 1: HV Pulse common params loaded: r-grant delays, r-grant scale, prescaler, timer values for seq1,seq2_pre, seq2_post, seq3"]
    #[inline(always)]
    #[must_use]
    pub fn hv_params_loaded(&mut self) -> HV_PARAMS_LOADED_W<RGRANT_DELAY_PRG_SPEC> {
        HV_PARAMS_LOADED_W::new(self, 31)
    }
