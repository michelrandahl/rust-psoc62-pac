...
pub type R = crate::R<RAM2_CTL0_SPEC>;
#[doc = "Register `RAM2_CTL0` writer"]
pub type W = crate::W<RAM2_CTL0_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn slow_ws(&mut self) -> SLOW_WS_W<RAM2_CTL0_SPEC> {
        SLOW_WS_W::new(self, 0)
    }
    #[doc = "Bits 8:9 - See RAM0_CTL."]
    #[inline(always)]
    #[must_use]
    pub fn fast_ws(&mut self) -> FAST_WS_W<RAM2_CTL0_SPEC> {
        FAST_WS_W::new(self, 8)
    }
    #[doc = "Bit 16 - See RAM0_CTL."]
    #[inline(always)]
    #[must_use]
    pub fn ecc_en(&mut self) -> ECC_EN_W<RAM2_CTL0_SPEC> {
        ECC_EN_W::new(self, 16)
    }
    #[doc = "Bit 17 - See RAM0_CTL."]
    #[inline(always)]
    #[must_use]
    pub fn ecc_auto_correct(&mut self) -> ECC_AUTO_CORRECT_W<RAM2_CTL0_SPEC> {
        ECC_AUTO_CORRECT_W::new(self, 17)
    }
    #[doc = "Bit 18 - See RAM0_CTL."]
    #[inline(always)]
    #[must_use]
    pub fn ecc_inj_en(&mut self) -> ECC_INJ_EN_W<RAM2_CTL0_SPEC> {
...
#[doc = "RAM 2 control\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ram2_ctl0::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ram2_ctl0::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
