...
pub type R = crate::R<SIE_EP_INT_EN_SPEC>;
#[doc = "Register `SIE_EP_INT_EN` writer"]
pub type W = crate::W<SIE_EP_INT_EN_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ep1_intr_en(&mut self) -> EP1_INTR_EN_W<SIE_EP_INT_EN_SPEC> {
        EP1_INTR_EN_W::new(self, 0)
    }
    #[doc = "Bit 1 - Enables interrupt for EP2"]
    #[inline(always)]
    #[must_use]
    pub fn ep2_intr_en(&mut self) -> EP2_INTR_EN_W<SIE_EP_INT_EN_SPEC> {
        EP2_INTR_EN_W::new(self, 1)
    }
    #[doc = "Bit 2 - Enables interrupt for EP3"]
    #[inline(always)]
    #[must_use]
    pub fn ep3_intr_en(&mut self) -> EP3_INTR_EN_W<SIE_EP_INT_EN_SPEC> {
        EP3_INTR_EN_W::new(self, 2)
    }
    #[doc = "Bit 3 - Enables interrupt for EP4"]
    #[inline(always)]
    #[must_use]
    pub fn ep4_intr_en(&mut self) -> EP4_INTR_EN_W<SIE_EP_INT_EN_SPEC> {
        EP4_INTR_EN_W::new(self, 3)
    }
    #[doc = "Bit 4 - Enables interrupt for EP5"]
    #[inline(always)]
    #[must_use]
    pub fn ep5_intr_en(&mut self) -> EP5_INTR_EN_W<SIE_EP_INT_EN_SPEC> {
        EP5_INTR_EN_W::new(self, 4)
    }
    #[doc = "Bit 5 - Enables interrupt for EP6"]
    #[inline(always)]
    #[must_use]
    pub fn ep6_intr_en(&mut self) -> EP6_INTR_EN_W<SIE_EP_INT_EN_SPEC> {
        EP6_INTR_EN_W::new(self, 5)
    }
    #[doc = "Bit 6 - Enables interrupt for EP7"]
    #[inline(always)]
    #[must_use]
    pub fn ep7_intr_en(&mut self) -> EP7_INTR_EN_W<SIE_EP_INT_EN_SPEC> {
        EP7_INTR_EN_W::new(self, 6)
    }
    #[doc = "Bit 7 - Enables interrupt for EP8"]
    #[inline(always)]
    #[must_use]
    pub fn ep8_intr_en(&mut self) -> EP8_INTR_EN_W<SIE_EP_INT_EN_SPEC> {
...
#[doc = "USB SIE Data Endpoints Interrupt Enable Register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`sie_ep_int_en::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`sie_ep_int_en::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
