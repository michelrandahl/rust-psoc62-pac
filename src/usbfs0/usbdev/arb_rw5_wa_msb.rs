...
pub type R = crate::R<ARB_RW5_WA_MSB_SPEC>;
#[doc = "Register `ARB_RW5_WA_MSB` writer"]
pub type W = crate::W<ARB_RW5_WA_MSB_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn wa_msb(&mut self) -> WA_MSB_W<ARB_RW5_WA_MSB_SPEC> {
        WA_MSB_W::new(self, 0)
    }
...
#[doc = "Endpoint Write Address value *1\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`arb_rw5_wa_msb::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`arb_rw5_wa_msb::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
