...
pub type R = crate::R<LUT_CTL_SPEC>;
#[doc = "Register `LUT_CTL[%s]` writer"]
pub type W = crate::W<LUT_CTL_SPEC>;
...
pub type LUT_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
...
pub type LUT_OPC_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn lut(&mut self) -> LUT_W<LUT_CTL_SPEC> {
        LUT_W::new(self, 0)
    }
    #[doc = "Bits 8:9 - LUT opcode specifies the LUT operation: '0': Combinatoral output, no feedback. tr_out = LUT\\[{tr2_in, tr1_in, tr0_in}\\]. '1': Combinatorial output, feedback. tr_out = LUT\\[{lut_reg, tr1_in, tr0_in}\\]. On clock: lut_reg &lt;= tr_in2. '2': Sequential output, no feedback. temp = LUT\\[{tr2_in, tr1_in, tr0_in}\\]. tr_out = lut_reg. On clock: lut_reg &lt;= temp. '3': Register with asynchronous set and reset. tr_out = lut_reg. enable = (tr2_in ^ LUT\\[4\\]) | LUT\\[5\\]. set = enable &amp; (tr1_in ^ LUT\\[2\\]) &amp; LUT\\[3\\]. clr = enable &amp; (tr0_in ^ LUT\\[0\\]) &amp; LUT\\[1\\]. Asynchronously (no clock required): lut_reg &lt;= if (clr) '0' else if (set) '1'"]
    #[inline(always)]
    #[must_use]
    pub fn lut_opc(&mut self) -> LUT_OPC_W<LUT_CTL_SPEC> {
        LUT_OPC_W::new(self, 8)
    }
...
#[doc = "LUT component control register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`lut_ctl::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`lut_ctl::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
