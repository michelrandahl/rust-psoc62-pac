...
pub type R = crate::R<SIE_EP5_CNT1_SPEC>;
#[doc = "Register `SIE_EP5_CNT1` writer"]
pub type W = crate::W<SIE_EP5_CNT1_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn data_count(&mut self) -> DATA_COUNT_W<SIE_EP5_CNT1_SPEC> {
...
#[doc = "Non-control endpoint count register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`sie_ep5_cnt1::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`sie_ep5_cnt1::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
