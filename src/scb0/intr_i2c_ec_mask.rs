...
pub type R = crate::R<INTR_I2C_EC_MASK_SPEC>;
#[doc = "Register `INTR_I2C_EC_MASK` writer"]
pub type W = crate::W<INTR_I2C_EC_MASK_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn wake_up(&mut self) -> WAKE_UP_W<INTR_I2C_EC_MASK_SPEC> {
        WAKE_UP_W::new(self, 0)
    }
    #[doc = "Bit 1 - Mask bit for corresponding bit in interrupt request register."]
    #[inline(always)]
    #[must_use]
    pub fn ez_stop(&mut self) -> EZ_STOP_W<INTR_I2C_EC_MASK_SPEC> {
        EZ_STOP_W::new(self, 1)
    }
    #[doc = "Bit 2 - Mask bit for corresponding bit in interrupt request register."]
    #[inline(always)]
    #[must_use]
    pub fn ez_write_stop(&mut self) -> EZ_WRITE_STOP_W<INTR_I2C_EC_MASK_SPEC> {
        EZ_WRITE_STOP_W::new(self, 2)
    }
    #[doc = "Bit 3 - Mask bit for corresponding bit in interrupt request register."]
    #[inline(always)]
    #[must_use]
    pub fn ez_read_stop(&mut self) -> EZ_READ_STOP_W<INTR_I2C_EC_MASK_SPEC> {
...
#[doc = "Externally clocked I2C interrupt mask\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`intr_i2c_ec_mask::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`intr_i2c_ec_mask::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
