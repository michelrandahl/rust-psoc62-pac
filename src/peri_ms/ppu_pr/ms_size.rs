...
pub type R = crate::R<MS_SIZE_SPEC>;
...
#[doc = "Master region, size\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ms_size::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
