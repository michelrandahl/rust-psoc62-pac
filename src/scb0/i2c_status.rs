...
pub type R = crate::R<I2C_STATUS_SPEC>;
...
#[doc = "I2C status\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`i2c_status::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
