...
pub type R = crate::R<INTR_CAUSE_HI_SPEC>;
...
#[doc = "High priority interrupt Cause register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`intr_cause_hi::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
