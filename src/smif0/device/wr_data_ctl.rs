...
pub type R = crate::R<WR_DATA_CTL_SPEC>;
#[doc = "Register `WR_DATA_CTL` writer"]
pub type W = crate::W<WR_DATA_CTL_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn width(&mut self) -> WIDTH_W<WR_DATA_CTL_SPEC> {
        WIDTH_W::new(self, 16)
    }
...
#[doc = "Write data control\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`wr_data_ctl::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`wr_data_ctl::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
