...
pub type R = crate::R<LPM_STAT_SPEC>;
...
#[doc = "LPM Status register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`lpm_stat::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
