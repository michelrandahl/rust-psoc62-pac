...
pub type R = crate::R<ARB_EP3_SR_SPEC>;
#[doc = "Register `ARB_EP3_SR` writer"]
pub type W = crate::W<ARB_EP3_SR_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn in_buf_full(&mut self) -> IN_BUF_FULL_W<ARB_EP3_SR_SPEC> {
        IN_BUF_FULL_W::new(self, 0)
    }
    #[doc = "Bit 1 - Endpoint DMA Grant Interrupt"]
    #[inline(always)]
    #[must_use]
    pub fn dma_gnt(&mut self) -> DMA_GNT_W<ARB_EP3_SR_SPEC> {
        DMA_GNT_W::new(self, 1)
    }
    #[doc = "Bit 2 - Endpoint Buffer Overflow Interrupt"]
    #[inline(always)]
    #[must_use]
    pub fn buf_over(&mut self) -> BUF_OVER_W<ARB_EP3_SR_SPEC> {
        BUF_OVER_W::new(self, 2)
    }
    #[doc = "Bit 3 - Endpoint Buffer Underflow Interrupt"]
    #[inline(always)]
    #[must_use]
    pub fn buf_under(&mut self) -> BUF_UNDER_W<ARB_EP3_SR_SPEC> {
        BUF_UNDER_W::new(self, 3)
    }
    #[doc = "Bit 5 - Endpoint DMA Terminated Interrupt"]
    #[inline(always)]
    #[must_use]
    pub fn dma_termin(&mut self) -> DMA_TERMIN_W<ARB_EP3_SR_SPEC> {
...
#[doc = "Endpoint Interrupt Enable Register *1\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`arb_ep3_sr::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`arb_ep3_sr::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
