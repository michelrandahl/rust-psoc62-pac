...
pub type R = crate::R<RD_ADDR_CTL_SPEC>;
#[doc = "Register `RD_ADDR_CTL` writer"]
pub type W = crate::W<RD_ADDR_CTL_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn width(&mut self) -> WIDTH_W<RD_ADDR_CTL_SPEC> {
        WIDTH_W::new(self, 16)
    }
...
#[doc = "Read address control\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`rd_addr_ctl::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`rd_addr_ctl::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
