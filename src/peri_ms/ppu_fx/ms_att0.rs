...
pub type R = crate::R<MS_ATT0_SPEC>;
#[doc = "Register `MS_ATT0` writer"]
pub type W = crate::W<MS_ATT0_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pc1_uw(&mut self) -> PC1_UW_W<MS_ATT0_SPEC> {
        PC1_UW_W::new(self, 9)
    }
    #[doc = "Bit 11 - Protection context 1, privileged write enable."]
    #[inline(always)]
    #[must_use]
    pub fn pc1_pw(&mut self) -> PC1_PW_W<MS_ATT0_SPEC> {
        PC1_PW_W::new(self, 11)
    }
    #[doc = "Bit 12 - Protection context 1, non-secure."]
    #[inline(always)]
    #[must_use]
    pub fn pc1_ns(&mut self) -> PC1_NS_W<MS_ATT0_SPEC> {
        PC1_NS_W::new(self, 12)
    }
    #[doc = "Bit 17 - Protection context 2, user write enable."]
    #[inline(always)]
    #[must_use]
    pub fn pc2_uw(&mut self) -> PC2_UW_W<MS_ATT0_SPEC> {
        PC2_UW_W::new(self, 17)
    }
    #[doc = "Bit 19 - Protection context 2, privileged write enable."]
    #[inline(always)]
    #[must_use]
    pub fn pc2_pw(&mut self) -> PC2_PW_W<MS_ATT0_SPEC> {
        PC2_PW_W::new(self, 19)
    }
    #[doc = "Bit 20 - Protection context 2, non-secure."]
    #[inline(always)]
    #[must_use]
    pub fn pc2_ns(&mut self) -> PC2_NS_W<MS_ATT0_SPEC> {
        PC2_NS_W::new(self, 20)
    }
    #[doc = "Bit 25 - Protection context 3, user write enable."]
    #[inline(always)]
    #[must_use]
    pub fn pc3_uw(&mut self) -> PC3_UW_W<MS_ATT0_SPEC> {
        PC3_UW_W::new(self, 25)
    }
    #[doc = "Bit 27 - Protection context 3, privileged write enable."]
    #[inline(always)]
    #[must_use]
    pub fn pc3_pw(&mut self) -> PC3_PW_W<MS_ATT0_SPEC> {
        PC3_PW_W::new(self, 27)
    }
    #[doc = "Bit 28 - Protection context 3, non-secure."]
    #[inline(always)]
    #[must_use]
    pub fn pc3_ns(&mut self) -> PC3_NS_W<MS_ATT0_SPEC> {
...
#[doc = "Master attributes 0\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ms_att0::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ms_att0::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
