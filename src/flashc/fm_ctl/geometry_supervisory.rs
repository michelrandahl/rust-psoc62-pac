...
pub type R = crate::R<GEOMETRY_SUPERVISORY_SPEC>;
...
#[doc = "Supervisory flash geometry\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`geometry_supervisory::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
