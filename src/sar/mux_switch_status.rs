...
pub type R = crate::R<MUX_SWITCH_STATUS_SPEC>;
...
#[doc = "SARMUX switch status\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`mux_switch_status::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
