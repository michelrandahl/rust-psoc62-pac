...
pub type R = crate::R<RD_MODE_CTL_SPEC>;
#[doc = "Register `RD_MODE_CTL` writer"]
pub type W = crate::W<RD_MODE_CTL_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn code(&mut self) -> CODE_W<RD_MODE_CTL_SPEC> {
        CODE_W::new(self, 0)
    }
    #[doc = "Bits 16:17 - Width of transfer."]
    #[inline(always)]
    #[must_use]
    pub fn width(&mut self) -> WIDTH_W<RD_MODE_CTL_SPEC> {
        WIDTH_W::new(self, 16)
    }
    #[doc = "Bit 31 - Presence of mode field: '0': not present '1': present"]
    #[inline(always)]
    #[must_use]
    pub fn present(&mut self) -> PRESENT_W<RD_MODE_CTL_SPEC> {
...
#[doc = "Read mode control\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`rd_mode_ctl::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`rd_mode_ctl::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
