...
pub type R = crate::R<SEQ_DEFAULT_SPEC>;
#[doc = "Register `SEQ_DEFAULT` writer"]
pub type W = crate::W<SEQ_DEFAULT_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn strobe_a(&mut self) -> STROBE_A_W<SEQ_DEFAULT_SPEC> {
        STROBE_A_W::new(self, 16)
    }
    #[doc = "Bit 17 - Specifies value of eFUSEcontrol signal strobe_b"]
    #[inline(always)]
    #[must_use]
    pub fn strobe_b(&mut self) -> STROBE_B_W<SEQ_DEFAULT_SPEC> {
        STROBE_B_W::new(self, 17)
    }
    #[doc = "Bit 18 - Specifies value of eFUSE control signal strobe_c"]
    #[inline(always)]
    #[must_use]
    pub fn strobe_c(&mut self) -> STROBE_C_W<SEQ_DEFAULT_SPEC> {
        STROBE_C_W::new(self, 18)
    }
    #[doc = "Bit 19 - Specifies value of eFUSE control signal strobe_d"]
    #[inline(always)]
    #[must_use]
    pub fn strobe_d(&mut self) -> STROBE_D_W<SEQ_DEFAULT_SPEC> {
        STROBE_D_W::new(self, 19)
    }
    #[doc = "Bit 20 - Specifies value of eFUSE control signal strobe_e"]
    #[inline(always)]
    #[must_use]
    pub fn strobe_e(&mut self) -> STROBE_E_W<SEQ_DEFAULT_SPEC> {
        STROBE_E_W::new(self, 20)
    }
    #[doc = "Bit 21 - Specifies value of eFUSE control signal strobe_f"]
    #[inline(always)]
    #[must_use]
    pub fn strobe_f(&mut self) -> STROBE_F_W<SEQ_DEFAULT_SPEC> {
        STROBE_F_W::new(self, 21)
    }
    #[doc = "Bit 22 - Specifies value of eFUSE control signal strobe_g"]
    #[inline(always)]
    #[must_use]
    pub fn strobe_g(&mut self) -> STROBE_G_W<SEQ_DEFAULT_SPEC> {
