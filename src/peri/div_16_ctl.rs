...
pub type R = crate::R<DIV_16_CTL_SPEC>;
#[doc = "Register `DIV_16_CTL[%s]` writer"]
pub type W = crate::W<DIV_16_CTL_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn int16_div(&mut self) -> INT16_DIV_W<DIV_16_CTL_SPEC> {
...
#[doc = "Divider control (for 16.0 divider)\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`div_16_ctl::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`div_16_ctl::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
