...
pub type R = crate::R<HOST_EP2_STATUS_SPEC>;
...
#[doc = "Host Endpoint 2 Status Register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`host_ep2_status::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
