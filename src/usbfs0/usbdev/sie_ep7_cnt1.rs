...
pub type R = crate::R<SIE_EP7_CNT1_SPEC>;
#[doc = "Register `SIE_EP7_CNT1` writer"]
pub type W = crate::W<SIE_EP7_CNT1_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn data_count(&mut self) -> DATA_COUNT_W<SIE_EP7_CNT1_SPEC> {
