...
pub type R = crate::R<PORT_SEL0_SPEC>;
#[doc = "Register `PORT_SEL0` writer"]
pub type W = crate::W<PORT_SEL0_SPEC>;
...
impl IO0_SEL_R {
    ...
    #[inline(always)]
    pub const fn variant(&self) -> IO0_SEL_A {
        match self.bits {
            0 => IO0_SEL_A::GPIO,
...
pub type IO0_SEL_W<'a, REG> = crate::FieldWriterSafe<'a, REG, 5, IO0_SEL_A>;
impl<'a, REG> IO0_SEL_W<'a, REG>
where
...
pub type IO1_SEL_W<'a, REG> = crate::FieldWriter<'a, REG, 5>;
...
pub type IO2_SEL_W<'a, REG> = crate::FieldWriter<'a, REG, 5>;
...
pub type IO3_SEL_W<'a, REG> = crate::FieldWriter<'a, REG, 5>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn io0_sel(&mut self) -> IO0_SEL_W<PORT_SEL0_SPEC> {
        IO0_SEL_W::new(self, 0)
    }
    #[doc = "Bits 8:12 - Selects connection for IO pin 1 route."]
    #[inline(always)]
    #[must_use]
    pub fn io1_sel(&mut self) -> IO1_SEL_W<PORT_SEL0_SPEC> {
        IO1_SEL_W::new(self, 8)
    }
    #[doc = "Bits 16:20 - Selects connection for IO pin 2 route."]
    #[inline(always)]
    #[must_use]
    pub fn io2_sel(&mut self) -> IO2_SEL_W<PORT_SEL0_SPEC> {
        IO2_SEL_W::new(self, 16)
    }
    #[doc = "Bits 24:28 - Selects connection for IO pin 3 route."]
    #[inline(always)]
    #[must_use]
    pub fn io3_sel(&mut self) -> IO3_SEL_W<PORT_SEL0_SPEC> {
        IO3_SEL_W::new(self, 24)
    }
...
#[doc = "Port selection 0\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`port_sel0::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`port_sel0::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
