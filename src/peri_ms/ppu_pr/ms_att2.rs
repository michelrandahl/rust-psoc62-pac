...
pub type R = crate::R<MS_ATT2_SPEC>;
#[doc = "Register `MS_ATT2` writer"]
pub type W = crate::W<MS_ATT2_SPEC>;
...
pub type PC8_UW_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type PC8_PW_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type PC8_NS_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type PC9_UW_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type PC9_PW_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type PC9_NS_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type PC10_UW_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type PC10_PW_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type PC10_NS_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type PC11_UW_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type PC11_PW_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type PC11_NS_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pc8_uw(&mut self) -> PC8_UW_W<MS_ATT2_SPEC> {
        PC8_UW_W::new(self, 1)
    }
    #[doc = "Bit 3 - Protection context 8, privileged write enable."]
    #[inline(always)]
    #[must_use]
    pub fn pc8_pw(&mut self) -> PC8_PW_W<MS_ATT2_SPEC> {
        PC8_PW_W::new(self, 3)
    }
    #[doc = "Bit 4 - Protection context 8, non-secure."]
    #[inline(always)]
    #[must_use]
    pub fn pc8_ns(&mut self) -> PC8_NS_W<MS_ATT2_SPEC> {
        PC8_NS_W::new(self, 4)
    }
    #[doc = "Bit 9 - Protection context 9, user write enable."]
    #[inline(always)]
    #[must_use]
    pub fn pc9_uw(&mut self) -> PC9_UW_W<MS_ATT2_SPEC> {
        PC9_UW_W::new(self, 9)
    }
    #[doc = "Bit 11 - Protection context 9, privileged write enable."]
    #[inline(always)]
    #[must_use]
    pub fn pc9_pw(&mut self) -> PC9_PW_W<MS_ATT2_SPEC> {
        PC9_PW_W::new(self, 11)
    }
    #[doc = "Bit 12 - Protection context 9, non-secure."]
    #[inline(always)]
    #[must_use]
    pub fn pc9_ns(&mut self) -> PC9_NS_W<MS_ATT2_SPEC> {
        PC9_NS_W::new(self, 12)
    }
    #[doc = "Bit 17 - Protection context 10, user write enable."]
    #[inline(always)]
    #[must_use]
    pub fn pc10_uw(&mut self) -> PC10_UW_W<MS_ATT2_SPEC> {
        PC10_UW_W::new(self, 17)
    }
    #[doc = "Bit 19 - Protection context 10, privileged write enable."]
    #[inline(always)]
    #[must_use]
    pub fn pc10_pw(&mut self) -> PC10_PW_W<MS_ATT2_SPEC> {
        PC10_PW_W::new(self, 19)
    }
    #[doc = "Bit 20 - Protection context 10, non-secure."]
    #[inline(always)]
    #[must_use]
    pub fn pc10_ns(&mut self) -> PC10_NS_W<MS_ATT2_SPEC> {
        PC10_NS_W::new(self, 20)
    }
    #[doc = "Bit 25 - Protection context 11, user write enable."]
    #[inline(always)]
    #[must_use]
    pub fn pc11_uw(&mut self) -> PC11_UW_W<MS_ATT2_SPEC> {
        PC11_UW_W::new(self, 25)
    }
    #[doc = "Bit 27 - Protection context 11, privileged write enable."]
    #[inline(always)]
    #[must_use]
    pub fn pc11_pw(&mut self) -> PC11_PW_W<MS_ATT2_SPEC> {
        PC11_PW_W::new(self, 27)
    }
    #[doc = "Bit 28 - Protection context 11, non-secure."]
    #[inline(always)]
    #[must_use]
    pub fn pc11_ns(&mut self) -> PC11_NS_W<MS_ATT2_SPEC> {
        PC11_NS_W::new(self, 28)
    }
