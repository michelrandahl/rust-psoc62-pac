...
pub type R = crate::R<SL_ATT3_SPEC>;
#[doc = "Register `SL_ATT3` writer"]
pub type W = crate::W<SL_ATT3_SPEC>;
...
pub type PC12_UR_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type PC12_UW_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type PC12_PR_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type PC12_PW_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type PC12_NS_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type PC13_UR_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type PC13_UW_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type PC13_PR_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type PC13_PW_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type PC13_NS_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type PC14_UR_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type PC14_UW_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type PC14_PR_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type PC14_PW_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type PC14_NS_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type PC15_UR_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type PC15_UW_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type PC15_PR_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type PC15_PW_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type PC15_NS_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pc12_ur(&mut self) -> PC12_UR_W<SL_ATT3_SPEC> {
        PC12_UR_W::new(self, 0)
    }
    #[doc = "Bit 1 - Protection context 12, user write enable."]
    #[inline(always)]
    #[must_use]
    pub fn pc12_uw(&mut self) -> PC12_UW_W<SL_ATT3_SPEC> {
        PC12_UW_W::new(self, 1)
    }
    #[doc = "Bit 2 - Protection context 12, privileged read enable."]
    #[inline(always)]
    #[must_use]
    pub fn pc12_pr(&mut self) -> PC12_PR_W<SL_ATT3_SPEC> {
        PC12_PR_W::new(self, 2)
    }
    #[doc = "Bit 3 - Protection context 12, privileged write enable."]
    #[inline(always)]
    #[must_use]
    pub fn pc12_pw(&mut self) -> PC12_PW_W<SL_ATT3_SPEC> {
        PC12_PW_W::new(self, 3)
    }
    #[doc = "Bit 4 - Protection context 12, non-secure."]
    #[inline(always)]
    #[must_use]
    pub fn pc12_ns(&mut self) -> PC12_NS_W<SL_ATT3_SPEC> {
        PC12_NS_W::new(self, 4)
    }
    #[doc = "Bit 8 - Protection context 13, user read enable."]
    #[inline(always)]
    #[must_use]
    pub fn pc13_ur(&mut self) -> PC13_UR_W<SL_ATT3_SPEC> {
        PC13_UR_W::new(self, 8)
    }
    #[doc = "Bit 9 - Protection context 13, user write enable."]
    #[inline(always)]
    #[must_use]
    pub fn pc13_uw(&mut self) -> PC13_UW_W<SL_ATT3_SPEC> {
        PC13_UW_W::new(self, 9)
    }
    #[doc = "Bit 10 - Protection context 13, privileged read enable."]
    #[inline(always)]
    #[must_use]
    pub fn pc13_pr(&mut self) -> PC13_PR_W<SL_ATT3_SPEC> {
        PC13_PR_W::new(self, 10)
    }
    #[doc = "Bit 11 - Protection context 13, privileged write enable."]
    #[inline(always)]
    #[must_use]
    pub fn pc13_pw(&mut self) -> PC13_PW_W<SL_ATT3_SPEC> {
        PC13_PW_W::new(self, 11)
    }
    #[doc = "Bit 12 - Protection context 13, non-secure."]
    #[inline(always)]
    #[must_use]
    pub fn pc13_ns(&mut self) -> PC13_NS_W<SL_ATT3_SPEC> {
        PC13_NS_W::new(self, 12)
    }
    #[doc = "Bit 16 - Protection context 14, user read enable."]
    #[inline(always)]
    #[must_use]
    pub fn pc14_ur(&mut self) -> PC14_UR_W<SL_ATT3_SPEC> {
        PC14_UR_W::new(self, 16)
    }
    #[doc = "Bit 17 - Protection context 14, user write enable."]
    #[inline(always)]
    #[must_use]
    pub fn pc14_uw(&mut self) -> PC14_UW_W<SL_ATT3_SPEC> {
        PC14_UW_W::new(self, 17)
    }
    #[doc = "Bit 18 - Protection context 14, privileged read enable."]
    #[inline(always)]
    #[must_use]
    pub fn pc14_pr(&mut self) -> PC14_PR_W<SL_ATT3_SPEC> {
        PC14_PR_W::new(self, 18)
    }
    #[doc = "Bit 19 - Protection context 14, privileged write enable."]
    #[inline(always)]
    #[must_use]
    pub fn pc14_pw(&mut self) -> PC14_PW_W<SL_ATT3_SPEC> {
        PC14_PW_W::new(self, 19)
    }
    #[doc = "Bit 20 - Protection context 14, non-secure."]
    #[inline(always)]
    #[must_use]
    pub fn pc14_ns(&mut self) -> PC14_NS_W<SL_ATT3_SPEC> {
        PC14_NS_W::new(self, 20)
    }
    #[doc = "Bit 24 - Protection context 15, user read enable."]
    #[inline(always)]
    #[must_use]
    pub fn pc15_ur(&mut self) -> PC15_UR_W<SL_ATT3_SPEC> {
        PC15_UR_W::new(self, 24)
    }
    #[doc = "Bit 25 - Protection context 15, user write enable."]
    #[inline(always)]
    #[must_use]
    pub fn pc15_uw(&mut self) -> PC15_UW_W<SL_ATT3_SPEC> {
        PC15_UW_W::new(self, 25)
    }
    #[doc = "Bit 26 - Protection context 15, privileged read enable."]
    #[inline(always)]
    #[must_use]
    pub fn pc15_pr(&mut self) -> PC15_PR_W<SL_ATT3_SPEC> {
        PC15_PR_W::new(self, 26)
    }
    #[doc = "Bit 27 - Protection context 15, privileged write enable."]
    #[inline(always)]
    #[must_use]
    pub fn pc15_pw(&mut self) -> PC15_PW_W<SL_ATT3_SPEC> {
        PC15_PW_W::new(self, 27)
    }
    #[doc = "Bit 28 - Protection context 15, non-secure."]
    #[inline(always)]
    #[must_use]
    pub fn pc15_ns(&mut self) -> PC15_NS_W<SL_ATT3_SPEC> {
        PC15_NS_W::new(self, 28)
    }
