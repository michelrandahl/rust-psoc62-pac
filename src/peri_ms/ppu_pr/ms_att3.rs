...
pub type R = crate::R<MS_ATT3_SPEC>;
#[doc = "Register `MS_ATT3` writer"]
pub type W = crate::W<MS_ATT3_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pc12_uw(&mut self) -> PC12_UW_W<MS_ATT3_SPEC> {
        PC12_UW_W::new(self, 1)
    }
    #[doc = "Bit 3 - Protection context 12, privileged write enable."]
    #[inline(always)]
    #[must_use]
    pub fn pc12_pw(&mut self) -> PC12_PW_W<MS_ATT3_SPEC> {
        PC12_PW_W::new(self, 3)
    }
    #[doc = "Bit 4 - Protection context 12, non-secure."]
    #[inline(always)]
    #[must_use]
    pub fn pc12_ns(&mut self) -> PC12_NS_W<MS_ATT3_SPEC> {
        PC12_NS_W::new(self, 4)
    }
    #[doc = "Bit 9 - Protection context 13, user write enable."]
    #[inline(always)]
    #[must_use]
    pub fn pc13_uw(&mut self) -> PC13_UW_W<MS_ATT3_SPEC> {
        PC13_UW_W::new(self, 9)
    }
    #[doc = "Bit 11 - Protection context 13, privileged write enable."]
    #[inline(always)]
    #[must_use]
    pub fn pc13_pw(&mut self) -> PC13_PW_W<MS_ATT3_SPEC> {
        PC13_PW_W::new(self, 11)
    }
    #[doc = "Bit 12 - Protection context 13, non-secure."]
    #[inline(always)]
    #[must_use]
    pub fn pc13_ns(&mut self) -> PC13_NS_W<MS_ATT3_SPEC> {
        PC13_NS_W::new(self, 12)
    }
    #[doc = "Bit 17 - Protection context 14, user write enable."]
    #[inline(always)]
    #[must_use]
    pub fn pc14_uw(&mut self) -> PC14_UW_W<MS_ATT3_SPEC> {
        PC14_UW_W::new(self, 17)
    }
    #[doc = "Bit 19 - Protection context 14, privileged write enable."]
    #[inline(always)]
    #[must_use]
    pub fn pc14_pw(&mut self) -> PC14_PW_W<MS_ATT3_SPEC> {
        PC14_PW_W::new(self, 19)
    }
    #[doc = "Bit 20 - Protection context 14, non-secure."]
    #[inline(always)]
    #[must_use]
    pub fn pc14_ns(&mut self) -> PC14_NS_W<MS_ATT3_SPEC> {
        PC14_NS_W::new(self, 20)
    }
    #[doc = "Bit 25 - Protection context 15, user write enable."]
    #[inline(always)]
    #[must_use]
    pub fn pc15_uw(&mut self) -> PC15_UW_W<MS_ATT3_SPEC> {
        PC15_UW_W::new(self, 25)
    }
    #[doc = "Bit 27 - Protection context 15, privileged write enable."]
    #[inline(always)]
    #[must_use]
    pub fn pc15_pw(&mut self) -> PC15_PW_W<MS_ATT3_SPEC> {
        PC15_PW_W::new(self, 27)
    }
    #[doc = "Bit 28 - Protection context 15, non-secure."]
    #[inline(always)]
    #[must_use]
    pub fn pc15_ns(&mut self) -> PC15_NS_W<MS_ATT3_SPEC> {
...
#[doc = "Master attributes 3\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ms_att3::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ms_att3::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
