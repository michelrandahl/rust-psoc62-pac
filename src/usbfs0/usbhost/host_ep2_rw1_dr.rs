...
pub type R = crate::R<HOST_EP2_RW1_DR_SPEC>;
#[doc = "Register `HOST_EP2_RW1_DR` writer"]
pub type W = crate::W<HOST_EP2_RW1_DR_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn bfdt8(&mut self) -> BFDT8_W<HOST_EP2_RW1_DR_SPEC> {
        BFDT8_W::new(self, 0)
    }
...
#[doc = "Host Endpoint 2 Data 1-Byte Register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`host_ep2_rw1_dr::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`host_ep2_rw1_dr::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
