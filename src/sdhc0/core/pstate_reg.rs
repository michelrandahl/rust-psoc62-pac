...
pub type R = crate::R<PSTATE_REG_SPEC>;
...
#[doc = "Present State Register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`pstate_reg::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
