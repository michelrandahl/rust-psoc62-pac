...
impl DRIVE_MODE0_R {
    ...
    #[inline(always)]
    pub const fn variant(&self) -> DRIVE_MODE0_A {
        match self.bits {
...
pub type DRIVE_MODE0_W<'a, REG> = crate::FieldWriterSafe<'a, REG, 3, DRIVE_MODE0_A>;
impl<'a, REG> DRIVE_MODE0_W<'a, REG>
where
...
pub type IN_EN0_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type DRIVE_MODE1_W<'a, REG> = crate::FieldWriter<'a, REG, 3>;
...
pub type IN_EN1_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type DRIVE_MODE2_W<'a, REG> = crate::FieldWriter<'a, REG, 3>;
...
pub type IN_EN2_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type DRIVE_MODE3_W<'a, REG> = crate::FieldWriter<'a, REG, 3>;
...
pub type IN_EN3_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type DRIVE_MODE4_W<'a, REG> = crate::FieldWriter<'a, REG, 3>;
...
pub type IN_EN4_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type DRIVE_MODE5_W<'a, REG> = crate::FieldWriter<'a, REG, 3>;
...
pub type IN_EN5_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type DRIVE_MODE6_W<'a, REG> = crate::FieldWriter<'a, REG, 3>;
...
pub type IN_EN6_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type DRIVE_MODE7_W<'a, REG> = crate::FieldWriter<'a, REG, 3>;
...
pub type IN_EN7_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn drive_mode0(&mut self) -> DRIVE_MODE0_W<CFG_SPEC> {
        DRIVE_MODE0_W::new(self, 0)
    }
    #[doc = "Bit 3 - Enables the input buffer for IO pin 0. This bit should be cleared when analog signals are present on the pin to avoid crowbar currents. The output buffer can be used to drive analog signals high or low without issue. '0': Input buffer disabled '1': Input buffer enabled"]
    #[inline(always)]
    #[must_use]
    pub fn in_en0(&mut self) -> IN_EN0_W<CFG_SPEC> {
        IN_EN0_W::new(self, 3)
    }
    #[doc = "Bits 4:6 - The GPIO drive mode for IO pin 1"]
    #[inline(always)]
    #[must_use]
    pub fn drive_mode1(&mut self) -> DRIVE_MODE1_W<CFG_SPEC> {
        DRIVE_MODE1_W::new(self, 4)
    }
    #[doc = "Bit 7 - Enables the input buffer for IO pin 1"]
    #[inline(always)]
    #[must_use]
    pub fn in_en1(&mut self) -> IN_EN1_W<CFG_SPEC> {
        IN_EN1_W::new(self, 7)
    }
    #[doc = "Bits 8:10 - The GPIO drive mode for IO pin 2"]
    #[inline(always)]
    #[must_use]
    pub fn drive_mode2(&mut self) -> DRIVE_MODE2_W<CFG_SPEC> {
        DRIVE_MODE2_W::new(self, 8)
    }
    #[doc = "Bit 11 - Enables the input buffer for IO pin 2"]
    #[inline(always)]
    #[must_use]
    pub fn in_en2(&mut self) -> IN_EN2_W<CFG_SPEC> {
        IN_EN2_W::new(self, 11)
    }
    #[doc = "Bits 12:14 - The GPIO drive mode for IO pin 3"]
    #[inline(always)]
    #[must_use]
    pub fn drive_mode3(&mut self) -> DRIVE_MODE3_W<CFG_SPEC> {
        DRIVE_MODE3_W::new(self, 12)
    }
    #[doc = "Bit 15 - Enables the input buffer for IO pin 3"]
    #[inline(always)]
    #[must_use]
    pub fn in_en3(&mut self) -> IN_EN3_W<CFG_SPEC> {
        IN_EN3_W::new(self, 15)
    }
    #[doc = "Bits 16:18 - The GPIO drive mode for IO pin4"]
    #[inline(always)]
    #[must_use]
    pub fn drive_mode4(&mut self) -> DRIVE_MODE4_W<CFG_SPEC> {
        DRIVE_MODE4_W::new(self, 16)
    }
    #[doc = "Bit 19 - Enables the input buffer for IO pin 4"]
    #[inline(always)]
    #[must_use]
    pub fn in_en4(&mut self) -> IN_EN4_W<CFG_SPEC> {
        IN_EN4_W::new(self, 19)
    }
    #[doc = "Bits 20:22 - The GPIO drive mode for IO pin 5"]
    #[inline(always)]
    #[must_use]
    pub fn drive_mode5(&mut self) -> DRIVE_MODE5_W<CFG_SPEC> {
        DRIVE_MODE5_W::new(self, 20)
    }
    #[doc = "Bit 23 - Enables the input buffer for IO pin 5"]
    #[inline(always)]
    #[must_use]
    pub fn in_en5(&mut self) -> IN_EN5_W<CFG_SPEC> {
        IN_EN5_W::new(self, 23)
    }
    #[doc = "Bits 24:26 - The GPIO drive mode for IO pin 6"]
    #[inline(always)]
    #[must_use]
    pub fn drive_mode6(&mut self) -> DRIVE_MODE6_W<CFG_SPEC> {
        DRIVE_MODE6_W::new(self, 24)
    }
    #[doc = "Bit 27 - Enables the input buffer for IO pin 6"]
    #[inline(always)]
    #[must_use]
    pub fn in_en6(&mut self) -> IN_EN6_W<CFG_SPEC> {
        IN_EN6_W::new(self, 27)
    }
    #[doc = "Bits 28:30 - The GPIO drive mode for IO pin 7"]
    #[inline(always)]
    #[must_use]
    pub fn drive_mode7(&mut self) -> DRIVE_MODE7_W<CFG_SPEC> {
        DRIVE_MODE7_W::new(self, 28)
    }
    #[doc = "Bit 31 - Enables the input buffer for IO pin 7"]
    #[inline(always)]
    #[must_use]
    pub fn in_en7(&mut self) -> IN_EN7_W<CFG_SPEC> {
        IN_EN7_W::new(self, 31)
    }
