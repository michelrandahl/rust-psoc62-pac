...
pub type R = crate::R<INJ_RESULT_SPEC>;
...
#[doc = "Injection channel result register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`inj_result::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
