...
pub type R = crate::R<ARB_RW5_DR_SPEC>;
#[doc = "Register `ARB_RW5_DR` writer"]
pub type W = crate::W<ARB_RW5_DR_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dr(&mut self) -> DR_W<ARB_RW5_DR_SPEC> {
        DR_W::new(self, 0)
    }
