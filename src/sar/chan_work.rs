...
pub type R = crate::R<CHAN_WORK_SPEC>;
...
#[doc = "Channel working data register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`chan_work::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
