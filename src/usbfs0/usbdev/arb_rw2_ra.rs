...
pub type R = crate::R<ARB_RW2_RA_SPEC>;
#[doc = "Register `ARB_RW2_RA` writer"]
pub type W = crate::W<ARB_RW2_RA_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ra(&mut self) -> RA_W<ARB_RW2_RA_SPEC> {
        RA_W::new(self, 0)
    }
