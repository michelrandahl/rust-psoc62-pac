...
pub type R = crate::R<CAPABILITIES2_R_SPEC>;
...
#[doc = "Capabilities Register - 32 to 63\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`capabilities2_r::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
