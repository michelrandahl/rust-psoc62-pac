...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn out0(&mut self) -> OUT0_W<OUT_SPEC> {
        OUT0_W::new(self, 0)
    }
    #[doc = "Bit 1 - IO output data for pin 1"]
    #[inline(always)]
    #[must_use]
    pub fn out1(&mut self) -> OUT1_W<OUT_SPEC> {
        OUT1_W::new(self, 1)
    }
    #[doc = "Bit 2 - IO output data for pin 2"]
    #[inline(always)]
    #[must_use]
    pub fn out2(&mut self) -> OUT2_W<OUT_SPEC> {
        OUT2_W::new(self, 2)
    }
    #[doc = "Bit 3 - IO output data for pin 3"]
    #[inline(always)]
    #[must_use]
    pub fn out3(&mut self) -> OUT3_W<OUT_SPEC> {
        OUT3_W::new(self, 3)
    }
    #[doc = "Bit 4 - IO output data for pin 4"]
    #[inline(always)]
    #[must_use]
    pub fn out4(&mut self) -> OUT4_W<OUT_SPEC> {
        OUT4_W::new(self, 4)
    }
    #[doc = "Bit 5 - IO output data for pin 5"]
    #[inline(always)]
    #[must_use]
    pub fn out5(&mut self) -> OUT5_W<OUT_SPEC> {
        OUT5_W::new(self, 5)
    }
    #[doc = "Bit 6 - IO output data for pin 6"]
    #[inline(always)]
    #[must_use]
    pub fn out6(&mut self) -> OUT6_W<OUT_SPEC> {
        OUT6_W::new(self, 6)
    }
    #[doc = "Bit 7 - IO output data for pin 7"]
    #[inline(always)]
    #[must_use]
    pub fn out7(&mut self) -> OUT7_W<OUT_SPEC> {
        OUT7_W::new(self, 7)
    }
