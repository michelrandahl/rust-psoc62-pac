...
pub type R = crate::R<ALM2_TIME_SPEC>;
#[doc = "Register `ALM2_TIME` writer"]
pub type W = crate::W<ALM2_TIME_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn alm_sec(&mut self) -> ALM_SEC_W<ALM2_TIME_SPEC> {
        ALM_SEC_W::new(self, 0)
    }
    #[doc = "Bit 7 - Alarm second enable: 0=ignore, 1=match"]
    #[inline(always)]
    #[must_use]
    pub fn alm_sec_en(&mut self) -> ALM_SEC_EN_W<ALM2_TIME_SPEC> {
        ALM_SEC_EN_W::new(self, 7)
    }
    #[doc = "Bits 8:14 - Alarm minutes in BCD, 0-59"]
    #[inline(always)]
    #[must_use]
    pub fn alm_min(&mut self) -> ALM_MIN_W<ALM2_TIME_SPEC> {
        ALM_MIN_W::new(self, 8)
    }
    #[doc = "Bit 15 - Alarm minutes enable: 0=ignore, 1=match"]
    #[inline(always)]
    #[must_use]
    pub fn alm_min_en(&mut self) -> ALM_MIN_EN_W<ALM2_TIME_SPEC> {
        ALM_MIN_EN_W::new(self, 15)
    }
    #[doc = "Bits 16:21 - Alarm hours in BCD, value depending on 12/24HR mode 12HR: \\[5\\]:0=AM, 1=PM, \\[4:0\\]=1-12 24HR: \\[5:0\\]=0-23"]
    #[inline(always)]
    #[must_use]
    pub fn alm_hour(&mut self) -> ALM_HOUR_W<ALM2_TIME_SPEC> {
        ALM_HOUR_W::new(self, 16)
    }
    #[doc = "Bit 23 - Alarm hour enable: 0=ignore, 1=match"]
    #[inline(always)]
    #[must_use]
    pub fn alm_hour_en(&mut self) -> ALM_HOUR_EN_W<ALM2_TIME_SPEC> {
        ALM_HOUR_EN_W::new(self, 23)
    }
    #[doc = "Bits 24:26 - Alarm Day of the week in BCD, 1-7 It is up to the user to define the meaning of the values, but 1=Monday is recommended"]
    #[inline(always)]
    #[must_use]
    pub fn alm_day(&mut self) -> ALM_DAY_W<ALM2_TIME_SPEC> {
        ALM_DAY_W::new(self, 24)
    }
    #[doc = "Bit 31 - Alarm Day of the Week enable: 0=ignore, 1=match"]
    #[inline(always)]
    #[must_use]
    pub fn alm_day_en(&mut self) -> ALM_DAY_EN_W<ALM2_TIME_SPEC> {
