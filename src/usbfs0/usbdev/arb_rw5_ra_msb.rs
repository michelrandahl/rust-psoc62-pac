...
pub type R = crate::R<ARB_RW5_RA_MSB_SPEC>;
#[doc = "Register `ARB_RW5_RA_MSB` writer"]
pub type W = crate::W<ARB_RW5_RA_MSB_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ra_msb(&mut self) -> RA_MSB_W<ARB_RW5_RA_MSB_SPEC> {
        RA_MSB_W::new(self, 0)
    }
