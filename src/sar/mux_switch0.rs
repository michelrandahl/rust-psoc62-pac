...
pub type R = crate::R<MUX_SWITCH0_SPEC>;
#[doc = "Register `MUX_SWITCH0` writer"]
pub type W = crate::W<MUX_SWITCH0_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn mux_fw_p0_vplus(&mut self) -> MUX_FW_P0_VPLUS_W<MUX_SWITCH0_SPEC> {
        MUX_FW_P0_VPLUS_W::new(self, 0)
    }
    #[doc = "Bit 1 - Firmware control: 0=open, 1=close switch between pin P1 and vplus signal. Write with '1' to set bit."]
    #[inline(always)]
    #[must_use]
    pub fn mux_fw_p1_vplus(&mut self) -> MUX_FW_P1_VPLUS_W<MUX_SWITCH0_SPEC> {
        MUX_FW_P1_VPLUS_W::new(self, 1)
    }
    #[doc = "Bit 2 - Firmware control: 0=open, 1=close switch between pin P2 and vplus signal. Write with '1' to set bit."]
    #[inline(always)]
    #[must_use]
    pub fn mux_fw_p2_vplus(&mut self) -> MUX_FW_P2_VPLUS_W<MUX_SWITCH0_SPEC> {
        MUX_FW_P2_VPLUS_W::new(self, 2)
    }
    #[doc = "Bit 3 - Firmware control: 0=open, 1=close switch between pin P3 and vplus signal. Write with '1' to set bit."]
    #[inline(always)]
    #[must_use]
    pub fn mux_fw_p3_vplus(&mut self) -> MUX_FW_P3_VPLUS_W<MUX_SWITCH0_SPEC> {
        MUX_FW_P3_VPLUS_W::new(self, 3)
    }
    #[doc = "Bit 4 - Firmware control: 0=open, 1=close switch between pin P4 and vplus signal. Write with '1' to set bit."]
    #[inline(always)]
    #[must_use]
    pub fn mux_fw_p4_vplus(&mut self) -> MUX_FW_P4_VPLUS_W<MUX_SWITCH0_SPEC> {
        MUX_FW_P4_VPLUS_W::new(self, 4)
    }
    #[doc = "Bit 5 - Firmware control: 0=open, 1=close switch between pin P5 and vplus signal. Write with '1' to set bit."]
    #[inline(always)]
    #[must_use]
    pub fn mux_fw_p5_vplus(&mut self) -> MUX_FW_P5_VPLUS_W<MUX_SWITCH0_SPEC> {
        MUX_FW_P5_VPLUS_W::new(self, 5)
    }
    #[doc = "Bit 6 - Firmware control: 0=open, 1=close switch between pin P6 and vplus signal. Write with '1' to set bit."]
    #[inline(always)]
    #[must_use]
    pub fn mux_fw_p6_vplus(&mut self) -> MUX_FW_P6_VPLUS_W<MUX_SWITCH0_SPEC> {
        MUX_FW_P6_VPLUS_W::new(self, 6)
    }
    #[doc = "Bit 7 - Firmware control: 0=open, 1=close switch between pin P7 and vplus signal. Write with '1' to set bit."]
    #[inline(always)]
    #[must_use]
    pub fn mux_fw_p7_vplus(&mut self) -> MUX_FW_P7_VPLUS_W<MUX_SWITCH0_SPEC> {
        MUX_FW_P7_VPLUS_W::new(self, 7)
    }
    #[doc = "Bit 8 - Firmware control: 0=open, 1=close switch between pin P0 and vminus signal. Write with '1' to set bit."]
    #[inline(always)]
    #[must_use]
    pub fn mux_fw_p0_vminus(&mut self) -> MUX_FW_P0_VMINUS_W<MUX_SWITCH0_SPEC> {
        MUX_FW_P0_VMINUS_W::new(self, 8)
    }
    #[doc = "Bit 9 - Firmware control: 0=open, 1=close switch between pin P1 and vminus signal. Write with '1' to set bit."]
    #[inline(always)]
    #[must_use]
    pub fn mux_fw_p1_vminus(&mut self) -> MUX_FW_P1_VMINUS_W<MUX_SWITCH0_SPEC> {
        MUX_FW_P1_VMINUS_W::new(self, 9)
    }
    #[doc = "Bit 10 - Firmware control: 0=open, 1=close switch between pin P2 and vminus signal. Write with '1' to set bit."]
    #[inline(always)]
    #[must_use]
    pub fn mux_fw_p2_vminus(&mut self) -> MUX_FW_P2_VMINUS_W<MUX_SWITCH0_SPEC> {
        MUX_FW_P2_VMINUS_W::new(self, 10)
    }
    #[doc = "Bit 11 - Firmware control: 0=open, 1=close switch between pin P3 and vminus signal. Write with '1' to set bit."]
    #[inline(always)]
    #[must_use]
    pub fn mux_fw_p3_vminus(&mut self) -> MUX_FW_P3_VMINUS_W<MUX_SWITCH0_SPEC> {
        MUX_FW_P3_VMINUS_W::new(self, 11)
    }
    #[doc = "Bit 12 - Firmware control: 0=open, 1=close switch between pin P4 and vminus signal. Write with '1' to set bit."]
    #[inline(always)]
    #[must_use]
    pub fn mux_fw_p4_vminus(&mut self) -> MUX_FW_P4_VMINUS_W<MUX_SWITCH0_SPEC> {
        MUX_FW_P4_VMINUS_W::new(self, 12)
    }
    #[doc = "Bit 13 - Firmware control: 0=open, 1=close switch between pin P5 and vminus signal. Write with '1' to set bit."]
    #[inline(always)]
    #[must_use]
    pub fn mux_fw_p5_vminus(&mut self) -> MUX_FW_P5_VMINUS_W<MUX_SWITCH0_SPEC> {
        MUX_FW_P5_VMINUS_W::new(self, 13)
    }
    #[doc = "Bit 14 - Firmware control: 0=open, 1=close switch between pin P6 and vminus signal. Write with '1' to set bit."]
    #[inline(always)]
    #[must_use]
    pub fn mux_fw_p6_vminus(&mut self) -> MUX_FW_P6_VMINUS_W<MUX_SWITCH0_SPEC> {
        MUX_FW_P6_VMINUS_W::new(self, 14)
    }
    #[doc = "Bit 15 - Firmware control: 0=open, 1=close switch between pin P7 and vminus signal. Write with '1' to set bit."]
    #[inline(always)]
    #[must_use]
    pub fn mux_fw_p7_vminus(&mut self) -> MUX_FW_P7_VMINUS_W<MUX_SWITCH0_SPEC> {
        MUX_FW_P7_VMINUS_W::new(self, 15)
    }
    #[doc = "Bit 16 - Firmware control: 0=open, 1=close switch between vssa_kelvin and vminus signal. Write with '1' to set bit."]
    #[inline(always)]
    #[must_use]
    pub fn mux_fw_vssa_vminus(&mut self) -> MUX_FW_VSSA_VMINUS_W<MUX_SWITCH0_SPEC> {
        MUX_FW_VSSA_VMINUS_W::new(self, 16)
    }
    #[doc = "Bit 17 - Firmware control: 0=open, 1=close switch between temperature sensor and vplus signal, also powers on the temperature sensor. Write with '1' to set bit."]
    #[inline(always)]
    #[must_use]
    pub fn mux_fw_temp_vplus(&mut self) -> MUX_FW_TEMP_VPLUS_W<MUX_SWITCH0_SPEC> {
        MUX_FW_TEMP_VPLUS_W::new(self, 17)
    }
    #[doc = "Bit 18 - Firmware control: 0=open, 1=close switch between amuxbusa and vplus signal. Write with '1' to set bit."]
    #[inline(always)]
    #[must_use]
    pub fn mux_fw_amuxbusa_vplus(&mut self) -> MUX_FW_AMUXBUSA_VPLUS_W<MUX_SWITCH0_SPEC> {
        MUX_FW_AMUXBUSA_VPLUS_W::new(self, 18)
    }
    #[doc = "Bit 19 - Firmware control: 0=open, 1=close switch between amuxbusb and vplus signal. Write with '1' to set bit."]
    #[inline(always)]
    #[must_use]
    pub fn mux_fw_amuxbusb_vplus(&mut self) -> MUX_FW_AMUXBUSB_VPLUS_W<MUX_SWITCH0_SPEC> {
        MUX_FW_AMUXBUSB_VPLUS_W::new(self, 19)
    }
    #[doc = "Bit 20 - Firmware control: 0=open, 1=close switch between amuxbusa and vminus signal. Write with '1' to set bit."]
    #[inline(always)]
    #[must_use]
    pub fn mux_fw_amuxbusa_vminus(&mut self) -> MUX_FW_AMUXBUSA_VMINUS_W<MUX_SWITCH0_SPEC> {
        MUX_FW_AMUXBUSA_VMINUS_W::new(self, 20)
    }
    #[doc = "Bit 21 - Firmware control: 0=open, 1=close switch between amuxbusb and vminus signal. Write with '1' to set bit."]
    #[inline(always)]
    #[must_use]
    pub fn mux_fw_amuxbusb_vminus(&mut self) -> MUX_FW_AMUXBUSB_VMINUS_W<MUX_SWITCH0_SPEC> {
        MUX_FW_AMUXBUSB_VMINUS_W::new(self, 21)
    }
    #[doc = "Bit 22 - Firmware control: 0=open, 1=close switch between sarbus0 and vplus signal. Write with '1' to set bit."]
    #[inline(always)]
    #[must_use]
    pub fn mux_fw_sarbus0_vplus(&mut self) -> MUX_FW_SARBUS0_VPLUS_W<MUX_SWITCH0_SPEC> {
        MUX_FW_SARBUS0_VPLUS_W::new(self, 22)
    }
    #[doc = "Bit 23 - Firmware control: 0=open, 1=close switch between sarbus1 and vplus signal. Write with '1' to set bit."]
    #[inline(always)]
    #[must_use]
    pub fn mux_fw_sarbus1_vplus(&mut self) -> MUX_FW_SARBUS1_VPLUS_W<MUX_SWITCH0_SPEC> {
        MUX_FW_SARBUS1_VPLUS_W::new(self, 23)
    }
    #[doc = "Bit 24 - Firmware control: 0=open, 1=close switch between sarbus0 and vminus signal. Write with '1' to set bit."]
    #[inline(always)]
    #[must_use]
    pub fn mux_fw_sarbus0_vminus(&mut self) -> MUX_FW_SARBUS0_VMINUS_W<MUX_SWITCH0_SPEC> {
        MUX_FW_SARBUS0_VMINUS_W::new(self, 24)
    }
    #[doc = "Bit 25 - Firmware control: 0=open, 1=close switch between sarbus1 and vminus signal. Write with '1' to set bit."]
    #[inline(always)]
    #[must_use]
    pub fn mux_fw_sarbus1_vminus(&mut self) -> MUX_FW_SARBUS1_VMINUS_W<MUX_SWITCH0_SPEC> {
        MUX_FW_SARBUS1_VMINUS_W::new(self, 25)
    }
    #[doc = "Bit 26 - Firmware control: 0=open, 1=close switch between P4 and coreio0 signal. Write with '1' to set bit."]
    #[inline(always)]
    #[must_use]
    pub fn mux_fw_p4_coreio0(&mut self) -> MUX_FW_P4_COREIO0_W<MUX_SWITCH0_SPEC> {
        MUX_FW_P4_COREIO0_W::new(self, 26)
    }
    #[doc = "Bit 27 - Firmware control: 0=open, 1=close switch between P5 and coreio1 signal. Write with '1' to set bit."]
    #[inline(always)]
    #[must_use]
    pub fn mux_fw_p5_coreio1(&mut self) -> MUX_FW_P5_COREIO1_W<MUX_SWITCH0_SPEC> {
        MUX_FW_P5_COREIO1_W::new(self, 27)
    }
    #[doc = "Bit 28 - Firmware control: 0=open, 1=close switch between P6 and coreio2 signal. Write with '1' to set bit."]
    #[inline(always)]
    #[must_use]
    pub fn mux_fw_p6_coreio2(&mut self) -> MUX_FW_P6_COREIO2_W<MUX_SWITCH0_SPEC> {
        MUX_FW_P6_COREIO2_W::new(self, 28)
    }
    #[doc = "Bit 29 - Firmware control: 0=open, 1=close switch between P7 and coreio3 signal. Write with '1' to set bit."]
    #[inline(always)]
    #[must_use]
    pub fn mux_fw_p7_coreio3(&mut self) -> MUX_FW_P7_COREIO3_W<MUX_SWITCH0_SPEC> {
