...
pub type R = crate::R<ARB_EP8_INT_EN_SPEC>;
#[doc = "Register `ARB_EP8_INT_EN` writer"]
pub type W = crate::W<ARB_EP8_INT_EN_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn in_buf_full_en(&mut self) -> IN_BUF_FULL_EN_W<ARB_EP8_INT_EN_SPEC> {
        IN_BUF_FULL_EN_W::new(self, 0)
    }
    #[doc = "Bit 1 - Endpoint DMA Grant Enable"]
    #[inline(always)]
    #[must_use]
    pub fn dma_gnt_en(&mut self) -> DMA_GNT_EN_W<ARB_EP8_INT_EN_SPEC> {
        DMA_GNT_EN_W::new(self, 1)
    }
    #[doc = "Bit 2 - Endpoint Buffer Overflow Enable"]
    #[inline(always)]
    #[must_use]
    pub fn buf_over_en(&mut self) -> BUF_OVER_EN_W<ARB_EP8_INT_EN_SPEC> {
        BUF_OVER_EN_W::new(self, 2)
    }
    #[doc = "Bit 3 - Endpoint Buffer Underflow Enable"]
    #[inline(always)]
    #[must_use]
    pub fn buf_under_en(&mut self) -> BUF_UNDER_EN_W<ARB_EP8_INT_EN_SPEC> {
        BUF_UNDER_EN_W::new(self, 3)
    }
    #[doc = "Bit 4 - Endpoint Error in Transaction Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn err_int_en(&mut self) -> ERR_INT_EN_W<ARB_EP8_INT_EN_SPEC> {
        ERR_INT_EN_W::new(self, 4)
    }
    #[doc = "Bit 5 - Endpoint DMA Terminated Enable"]
    #[inline(always)]
    #[must_use]
    pub fn dma_termin_en(&mut self) -> DMA_TERMIN_EN_W<ARB_EP8_INT_EN_SPEC> {
...
#[doc = "Endpoint Interrupt Enable Register *1\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`arb_ep8_int_en::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`arb_ep8_int_en::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
