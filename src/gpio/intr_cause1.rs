...
pub type R = crate::R<INTR_CAUSE1_SPEC>;
...
#[doc = "Interrupt port cause register 1\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`intr_cause1::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
