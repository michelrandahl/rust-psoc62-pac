...
pub type R = crate::R<ARB_RW5_RA16_SPEC>;
#[doc = "Register `ARB_RW5_RA16` writer"]
pub type W = crate::W<ARB_RW5_RA16_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ra16(&mut self) -> RA16_W<ARB_RW5_RA16_SPEC> {
        RA16_W::new(self, 0)
    }
...
#[doc = "Endpoint Read Address value\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`arb_rw5_ra16::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`arb_rw5_ra16::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
