...
pub type R = crate::R<SENSE_PERIOD_SPEC>;
#[doc = "Register `SENSE_PERIOD` writer"]
pub type W = crate::W<SENSE_PERIOD_SPEC>;
...
pub type SENSE_DIV_W<'a, REG> = crate::FieldWriter<'a, REG, 12, u16>;
...
impl LFSR_SIZE_R {
    ...
    #[inline(always)]
    pub const fn variant(&self) -> Option<LFSR_SIZE_A> {
        match self.bits {
...
pub type LFSR_SIZE_W<'a, REG> = crate::FieldWriter<'a, REG, 3, LFSR_SIZE_A>;
impl<'a, REG> LFSR_SIZE_W<'a, REG>
where
...
pub type LFSR_SCALE_W<'a, REG> = crate::FieldWriter<'a, REG, 4>;
...
pub type LFSR_CLEAR_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type SEL_LFSR_MSB_W<'a, REG> = crate::BitWriter<'a, REG>;
...
impl LFSR_BITS_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> LFSR_BITS_A {
        match self.bits {
            0 => LFSR_BITS_A::_2B,
            1 => LFSR_BITS_A::_3B,
            2 => LFSR_BITS_A::_4B,
...
pub type LFSR_BITS_W<'a, REG> = crate::FieldWriterSafe<'a, REG, 2, LFSR_BITS_A>;
impl<'a, REG> LFSR_BITS_W<'a, REG>
where
    REG: crate::Writable + crate::RegisterSpec,
    REG::Ux: From<u8>,
{
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn sense_div(&mut self) -> SENSE_DIV_W<SENSE_PERIOD_SPEC> {
        SENSE_DIV_W::new(self, 0)
    }
    #[doc = "Bits 16:18 - Selects the length of the LFSR which determines the LFSR repeat period. LFSR_BITS LSB of the LFSR are used for the clock dithering variation on the base period (was PRS in CSDv1). Whenever the LFSR is used (non zero value in this field) the LFSR_CLEAR bit should also be set."]
    #[inline(always)]
    #[must_use]
    pub fn lfsr_size(&mut self) -> LFSR_SIZE_W<SENSE_PERIOD_SPEC> {
        LFSR_SIZE_W::new(self, 16)
    }
    #[doc = "Bits 20:23 - Shift the LFSR output left by LSFR_SCALE bits before adding to SENSE_DIV. This dithering is disabled when SEL_LSFR_MSB is set. The clock divider to be used = (SENSE_DIV+1) + (SEL_LSFR_MSB ? 0 : (LFSR_OUT&lt;&lt;LFSR_SCALE)). Note that the clock divider including the dithering term must fit in 12 bits, otherwise the result is undefined."]
    #[inline(always)]
    #[must_use]
    pub fn lfsr_scale(&mut self) -> LFSR_SCALE_W<SENSE_PERIOD_SPEC> {
        LFSR_SCALE_W::new(self, 20)
    }
    #[doc = "Bit 24 - When set, forces the LFSR to it's initial state (all ones). This bit is automatically cleared by hardware after the LFSR is cleared, which is at the next clk_csd positive edge. This bit should be set whenever this register is written and the LFSR is used. Note that the LFSR will also get reset to all ones during the AutoZero_1/2 states."]
    #[inline(always)]
    #[must_use]
    pub fn lfsr_clear(&mut self) -> LFSR_CLEAR_W<SENSE_PERIOD_SPEC> {
        LFSR_CLEAR_W::new(self, 24)
    }
    #[doc = "Bit 25 - Use the MSB of configured LSFR size as csd_sense signal. Intended to be used only with bit 8 or 12-bit LFSR size for CSDv1 backward compatibility (PRS). When this bit is set then clock divider dithering is disabled and SENSE_WIDTH is disabled."]
    #[inline(always)]
    #[must_use]
    pub fn sel_lfsr_msb(&mut self) -> SEL_LFSR_MSB_W<SENSE_PERIOD_SPEC> {
        SEL_LFSR_MSB_W::new(self, 25)
    }
    #[doc = "Bits 26:27 - Selects the number of LSB bits to use from the LSFR to provide the clock dithering variation on the base period. Caveat make sure that SENSE_DIV > the maximum absolute range (e.g. for 4B SENSE_DIV > 8), otherwise results are undefined."]
    #[inline(always)]
    #[must_use]
    pub fn lfsr_bits(&mut self) -> LFSR_BITS_W<SENSE_PERIOD_SPEC> {
        LFSR_BITS_W::new(self, 26)
    }
...
#[doc = "Sense clock period\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`sense_period::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`sense_period::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
