...
pub type R = crate::R<NORMAL_INT_SIGNAL_EN_R_SPEC>;
#[doc = "Register `NORMAL_INT_SIGNAL_EN_R` writer"]
pub type W = crate::W<NORMAL_INT_SIGNAL_EN_R_SPEC>;
...
pub type CMD_COMPLETE_SIGNAL_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type XFER_COMPLETE_SIGNAL_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type BGAP_EVENT_SIGNAL_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type DMA_INTERRUPT_SIGNAL_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type BUF_WR_READY_SIGNAL_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type BUF_RD_READY_SIGNAL_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type CARD_INSERTION_SIGNAL_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type CARD_REMOVAL_SIGNAL_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type RE_TUNE_EVENT_SIGNAL_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type FX_EVENT_SIGNAL_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type CQE_EVENT_SIGNAL_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
...
impl W {
    ...
    pub fn cmd_complete_signal_en(
        &mut self,
    ) -> CMD_COMPLETE_SIGNAL_EN_W<NORMAL_INT_SIGNAL_EN_R_SPEC> {
        CMD_COMPLETE_SIGNAL_EN_W::new(self, 0)
    }
    #[doc = "Bit 1 - Transfer Complete Signal Enable Values: - 0x0 (FALSE): Masked - 0x1 (TRUE): Enabled"]
    #[inline(always)]
    #[must_use]
    pub fn xfer_complete_signal_en(
        &mut self,
    ) -> XFER_COMPLETE_SIGNAL_EN_W<NORMAL_INT_SIGNAL_EN_R_SPEC> {
        XFER_COMPLETE_SIGNAL_EN_W::new(self, 1)
    }
    #[doc = "Bit 2 - Block Gap Event Signal Enable Values: - 0x0 (FALSE): Masked - 0x1 (TRUE): Enabled"]
    #[inline(always)]
    #[must_use]
    pub fn bgap_event_signal_en(&mut self) -> BGAP_EVENT_SIGNAL_EN_W<NORMAL_INT_SIGNAL_EN_R_SPEC> {
        BGAP_EVENT_SIGNAL_EN_W::new(self, 2)
    }
    #[doc = "Bit 3 - DMA Interrupt Signal Enable Values: - 0x0 (FALSE): Masked - 0x1 (TRUE): Enabled"]
    #[inline(always)]
    #[must_use]
    pub fn dma_interrupt_signal_en(
        &mut self,
    ) -> DMA_INTERRUPT_SIGNAL_EN_W<NORMAL_INT_SIGNAL_EN_R_SPEC> {
        DMA_INTERRUPT_SIGNAL_EN_W::new(self, 3)
    }
    #[doc = "Bit 4 - Buffer Write Ready Signal Enable Values: - 0x0 (FALSE): Masked - 0x1 (TRUE): Enabled"]
    #[inline(always)]
    #[must_use]
    pub fn buf_wr_ready_signal_en(
        &mut self,
    ) -> BUF_WR_READY_SIGNAL_EN_W<NORMAL_INT_SIGNAL_EN_R_SPEC> {
        BUF_WR_READY_SIGNAL_EN_W::new(self, 4)
    }
    #[doc = "Bit 5 - Buffer Read Ready Signal Enable Values: - 0x0 (FALSE): Masked - 0x1 (TRUE): Enabled"]
    #[inline(always)]
    #[must_use]
    pub fn buf_rd_ready_signal_en(
        &mut self,
    ) -> BUF_RD_READY_SIGNAL_EN_W<NORMAL_INT_SIGNAL_EN_R_SPEC> {
        BUF_RD_READY_SIGNAL_EN_W::new(self, 5)
    }
    #[doc = "Bit 6 - Card Insertion Signal Enable Values: - 0x0 (FALSE): Masked - 0x1 (TRUE): Enabled"]
    #[inline(always)]
    #[must_use]
    pub fn card_insertion_signal_en(
        &mut self,
    ) -> CARD_INSERTION_SIGNAL_EN_W<NORMAL_INT_SIGNAL_EN_R_SPEC> {
        CARD_INSERTION_SIGNAL_EN_W::new(self, 6)
    }
    #[doc = "Bit 7 - Card Removal Signal Enable Values: - 0x0 (FALSE): Masked - 0x1 (TRUE): Enabled"]
    #[inline(always)]
    #[must_use]
    pub fn card_removal_signal_en(
        &mut self,
    ) -> CARD_REMOVAL_SIGNAL_EN_W<NORMAL_INT_SIGNAL_EN_R_SPEC> {
        CARD_REMOVAL_SIGNAL_EN_W::new(self, 7)
    }
    #[doc = "Bit 8 - Card Interrupt Signal Enable Values: - 0x0 (FALSE): Masked - 0x1 (TRUE): Enabled"]
    #[inline(always)]
    #[must_use]
    pub fn card_interrupt_signal_en(
        &mut self,
    ) -> CARD_INTERRUPT_SIGNAL_EN_W<NORMAL_INT_SIGNAL_EN_R_SPEC> {
        CARD_INTERRUPT_SIGNAL_EN_W::new(self, 8)
    }
    #[doc = "Bit 9 - N/A"]
    #[inline(always)]
    #[must_use]
    pub fn int_a_signal_en(&mut self) -> INT_A_SIGNAL_EN_W<NORMAL_INT_SIGNAL_EN_R_SPEC> {
        INT_A_SIGNAL_EN_W::new(self, 9)
    }
    #[doc = "Bit 10 - N/A"]
    #[inline(always)]
    #[must_use]
    pub fn int_b_signal_en(&mut self) -> INT_B_SIGNAL_EN_W<NORMAL_INT_SIGNAL_EN_R_SPEC> {
        INT_B_SIGNAL_EN_W::new(self, 10)
    }
    #[doc = "Bit 11 - N/A"]
    #[inline(always)]
    #[must_use]
    pub fn int_c_signal_en(&mut self) -> INT_C_SIGNAL_EN_W<NORMAL_INT_SIGNAL_EN_R_SPEC> {
        INT_C_SIGNAL_EN_W::new(self, 11)
    }
    #[doc = "Bit 12 - N/A"]
    #[inline(always)]
    #[must_use]
    pub fn re_tune_event_signal_en(
        &mut self,
    ) -> RE_TUNE_EVENT_SIGNAL_EN_W<NORMAL_INT_SIGNAL_EN_R_SPEC> {
        RE_TUNE_EVENT_SIGNAL_EN_W::new(self, 12)
    }
    #[doc = "Bit 13 - FX Event Signal Enable Values: - 0x0 (FALSE): Masked - 0x1 (TRUE): Enabled"]
    #[inline(always)]
    #[must_use]
    pub fn fx_event_signal_en(&mut self) -> FX_EVENT_SIGNAL_EN_W<NORMAL_INT_SIGNAL_EN_R_SPEC> {
        FX_EVENT_SIGNAL_EN_W::new(self, 13)
    }
    #[doc = "Bit 14 - Command Queuing Engine Event Signal Enable Values: - 0x0 (FALSE): Masked - 0x1 (TRUE): Enabled"]
    #[inline(always)]
    #[must_use]
    pub fn cqe_event_signal_en(&mut self) -> CQE_EVENT_SIGNAL_EN_W<NORMAL_INT_SIGNAL_EN_R_SPEC> {
        CQE_EVENT_SIGNAL_EN_W::new(self, 14)
    }
...
#[doc = "Normal Interrupt Signal Enable Register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`normal_int_signal_en_r::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`normal_int_signal_en_r::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
