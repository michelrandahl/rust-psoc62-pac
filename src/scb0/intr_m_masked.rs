...
pub type R = crate::R<INTR_M_MASKED_SPEC>;
...
#[doc = "Master interrupt masked request\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`intr_m_masked::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
