...
pub type R = crate::R<WR_MODE_CTL_SPEC>;
#[doc = "Register `WR_MODE_CTL` writer"]
pub type W = crate::W<WR_MODE_CTL_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn code(&mut self) -> CODE_W<WR_MODE_CTL_SPEC> {
        CODE_W::new(self, 0)
    }
    #[doc = "Bits 16:17 - Width of transfer."]
    #[inline(always)]
    #[must_use]
    pub fn width(&mut self) -> WIDTH_W<WR_MODE_CTL_SPEC> {
        WIDTH_W::new(self, 16)
    }
    #[doc = "Bit 31 - Presence of mode field: '0': not present '1': present"]
    #[inline(always)]
    #[must_use]
    pub fn present(&mut self) -> PRESENT_W<WR_MODE_CTL_SPEC> {
