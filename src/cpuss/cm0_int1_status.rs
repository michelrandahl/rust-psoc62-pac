...
pub type R = crate::R<CM0_INT1_STATUS_SPEC>;
...
#[doc = "CM0+ interrupt 1 status\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`cm0_int1_status::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
