...
pub type R = crate::R<DP_STATUS_SPEC>;
...
#[doc = "Debug port status\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`dp_status::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
