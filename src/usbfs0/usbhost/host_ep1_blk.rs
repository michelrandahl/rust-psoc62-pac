...
pub type R = crate::R<HOST_EP1_BLK_SPEC>;
#[doc = "Register `HOST_EP1_BLK` writer"]
pub type W = crate::W<HOST_EP1_BLK_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn blk_num(&mut self) -> BLK_NUM_W<HOST_EP1_BLK_SPEC> {
...
#[doc = "Host Endpoint 1 Block Register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`host_ep1_blk::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`host_ep1_blk::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
