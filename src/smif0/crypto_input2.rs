...
pub type R = crate::R<CRYPTO_INPUT2_SPEC>;
#[doc = "Register `CRYPTO_INPUT2` writer"]
pub type W = crate::W<CRYPTO_INPUT2_SPEC>;
...
= CRYPTO_INPUT2.INPUT\\[31:0\\]."]
    #[inline(always)]
    #[must_use]
    pub fn input(&mut self) -> INPUT_W<CRYPTO_INPUT2_SPEC> {
        INPUT_W::new(self, 0)
    }
...
#[doc = "Cryptography input 2\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`crypto_input2::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`crypto_input2::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
