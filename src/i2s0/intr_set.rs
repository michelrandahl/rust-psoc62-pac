...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn tx_trigger(&mut self) -> TX_TRIGGER_W<INTR_SET_SPEC> {
        TX_TRIGGER_W::new(self, 0)
    }
    #[doc = "Bit 1 - Write with '1' to set corresponding bit in interrupt request register."]
    #[inline(always)]
    #[must_use]
    pub fn tx_not_full(&mut self) -> TX_NOT_FULL_W<INTR_SET_SPEC> {
        TX_NOT_FULL_W::new(self, 1)
    }
    #[doc = "Bit 4 - Write with '1' to set corresponding bit in interrupt request register."]
    #[inline(always)]
    #[must_use]
    pub fn tx_empty(&mut self) -> TX_EMPTY_W<INTR_SET_SPEC> {
        TX_EMPTY_W::new(self, 4)
    }
    #[doc = "Bit 5 - Write with '1' to set corresponding bit in interrupt request register."]
    #[inline(always)]
    #[must_use]
    pub fn tx_overflow(&mut self) -> TX_OVERFLOW_W<INTR_SET_SPEC> {
        TX_OVERFLOW_W::new(self, 5)
    }
    #[doc = "Bit 6 - Write with '1' to set corresponding bit in interrupt request register."]
    #[inline(always)]
    #[must_use]
    pub fn tx_underflow(&mut self) -> TX_UNDERFLOW_W<INTR_SET_SPEC> {
        TX_UNDERFLOW_W::new(self, 6)
    }
    #[doc = "Bit 8 - Write with '1' to set corresponding bit in interrupt request register."]
    #[inline(always)]
    #[must_use]
    pub fn tx_wd(&mut self) -> TX_WD_W<INTR_SET_SPEC> {
        TX_WD_W::new(self, 8)
    }
    #[doc = "Bit 16 - Write with '1' to set corresponding bit in interrupt request register."]
    #[inline(always)]
    ...
    #[inline(always)]
    #[must_use]
    pub fn rx_full(&mut self) -> RX_FULL_W<INTR_SET_SPEC> {
    ...
    #[inline(always)]
    #[must_use]
    pub fn rx_wd(&mut self) -> RX_WD_W<INTR_SET_SPEC> {
        RX_WD_W::new(self, 24)
    }
