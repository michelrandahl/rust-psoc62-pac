...
pub type R = crate::R<ALM1_DATE_SPEC>;
#[doc = "Register `ALM1_DATE` writer"]
pub type W = crate::W<ALM1_DATE_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn alm_date(&mut self) -> ALM_DATE_W<ALM1_DATE_SPEC> {
        ALM_DATE_W::new(self, 0)
    }
    #[doc = "Bit 7 - Alarm Day of the Month enable: 0=ignore, 1=match"]
    #[inline(always)]
    #[must_use]
    pub fn alm_date_en(&mut self) -> ALM_DATE_EN_W<ALM1_DATE_SPEC> {
        ALM_DATE_EN_W::new(self, 7)
    }
    #[doc = "Bits 8:12 - Alarm Month in BCD, 1-12"]
    #[inline(always)]
    #[must_use]
    pub fn alm_mon(&mut self) -> ALM_MON_W<ALM1_DATE_SPEC> {
        ALM_MON_W::new(self, 8)
    }
    #[doc = "Bit 15 - Alarm Month enable: 0=ignore, 1=match"]
    #[inline(always)]
    #[must_use]
    pub fn alm_mon_en(&mut self) -> ALM_MON_EN_W<ALM1_DATE_SPEC> {
        ALM_MON_EN_W::new(self, 15)
    }
    #[doc = "Bit 31 - Master enable for alarm 1. 0: Alarm 1 is disabled. Fields for date and time are ignored. 1: Alarm 1 is enabled. If none of the date and time fields are enabled, then this alarm triggers once every second."]
    #[inline(always)]
    #[must_use]
    pub fn alm_en(&mut self) -> ALM_EN_W<ALM1_DATE_SPEC> {
