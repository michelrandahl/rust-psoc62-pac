...
pub type R = crate::R<CM4_INT4_STATUS_SPEC>;
...
#[doc = "CM4 interrupt 4 status\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`cm4_int4_status::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
