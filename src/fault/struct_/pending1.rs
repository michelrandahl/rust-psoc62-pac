...
pub type R = crate::R<PENDING1_SPEC>;
...
#[doc = "Fault pending 1\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`pending1::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
