...
pub type R = crate::R<SEQ_PROGRAM_CTL_3_SPEC>;
#[doc = "Register `SEQ_PROGRAM_CTL_3` writer"]
pub type W = crate::W<SEQ_PROGRAM_CTL_3_SPEC>;
...
IP clock cycles."]
    #[inline(always)]
    #[must_use]
    pub fn cycles(&mut self) -> CYCLES_W<SEQ_PROGRAM_CTL_3_SPEC> {
        CYCLES_W::new(self, 0)
    }
    #[doc = "Bit 16 - Specifies value of eFUSE control signal strobe_a"]
    #[inline(always)]
    #[must_use]
    pub fn strobe_a(&mut self) -> STROBE_A_W<SEQ_PROGRAM_CTL_3_SPEC> {
        STROBE_A_W::new(self, 16)
    }
    #[doc = "Bit 17 - Specifies value of eFUSEcontrol signal strobe_b"]
    #[inline(always)]
    #[must_use]
    pub fn strobe_b(&mut self) -> STROBE_B_W<SEQ_PROGRAM_CTL_3_SPEC> {
        STROBE_B_W::new(self, 17)
    }
    #[doc = "Bit 18 - Specifies value of eFUSE control signal strobe_c"]
    #[inline(always)]
    #[must_use]
    pub fn strobe_c(&mut self) -> STROBE_C_W<SEQ_PROGRAM_CTL_3_SPEC> {
        STROBE_C_W::new(self, 18)
    }
    #[doc = "Bit 19 - Specifies value of eFUSE control signal strobe_d"]
    #[inline(always)]
    #[must_use]
    pub fn strobe_d(&mut self) -> STROBE_D_W<SEQ_PROGRAM_CTL_3_SPEC> {
        STROBE_D_W::new(self, 19)
    }
    #[doc = "Bit 20 - Specifies value of eFUSE control signal strobe_e"]
    #[inline(always)]
    #[must_use]
    pub fn strobe_e(&mut self) -> STROBE_E_W<SEQ_PROGRAM_CTL_3_SPEC> {
        STROBE_E_W::new(self, 20)
    }
    #[doc = "Bit 21 - Specifies value of eFUSE control signal strobe_f"]
    #[inline(always)]
    #[must_use]
    pub fn strobe_f(&mut self) -> STROBE_F_W<SEQ_PROGRAM_CTL_3_SPEC> {
        STROBE_F_W::new(self, 21)
    }
    #[doc = "Bit 22 - Specifies value of eFUSE control signal strobe_g"]
    #[inline(always)]
    #[must_use]
    pub fn strobe_g(&mut self) -> STROBE_G_W<SEQ_PROGRAM_CTL_3_SPEC> {
        STROBE_G_W::new(self, 22)
    }
    #[doc = "Bit 31 - When set to 1 indicates that the Read cycle ends when the current cycle count reaches 0."]
    #[inline(always)]
    #[must_use]
    pub fn done(&mut self) -> DONE_W<SEQ_PROGRAM_CTL_3_SPEC> {
        DONE_W::new(self, 31)
    }
...
#[doc = "Sequencer program control 3\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`seq_program_ctl_3::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`seq_program_ctl_3::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
