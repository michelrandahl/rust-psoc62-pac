...
pub type R = crate::R<CMD_RESP_STATUS_SPEC>;
...
#[doc = "Command/response status\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`cmd_resp_status::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
