...
pub type R = crate::R<INTR_HOST_EP_CAUSE_LO_SPEC>;
...
#[doc = "Interrupt USB Host Endpoint Cause Low Register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`intr_host_ep_cause_lo::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
