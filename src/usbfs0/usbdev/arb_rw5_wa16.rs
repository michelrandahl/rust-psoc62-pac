...
pub type R = crate::R<ARB_RW5_WA16_SPEC>;
#[doc = "Register `ARB_RW5_WA16` writer"]
pub type W = crate::W<ARB_RW5_WA16_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn wa16(&mut self) -> WA16_W<ARB_RW5_WA16_SPEC> {
        WA16_W::new(self, 0)
    }
...
#[doc = "Endpoint Write Address value\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`arb_rw5_wa16::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`arb_rw5_wa16::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
