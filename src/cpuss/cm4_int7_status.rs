...
pub type R = crate::R<CM4_INT7_STATUS_SPEC>;
...
#[doc = "CM4 interrupt 7 status\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`cm4_int7_status::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
