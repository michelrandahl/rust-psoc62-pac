...
pub type R = crate::R<ACQUIRE_SPEC>;
...
#[doc = "IPC acquire\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`acquire::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
