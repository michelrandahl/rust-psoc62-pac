...
pub type R = crate::R<IDENTITY_SPEC>;
...
#[doc = "Identity\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`identity::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
