...
pub type R = crate::R<ARB_RW7_RA_SPEC>;
#[doc = "Register `ARB_RW7_RA` writer"]
pub type W = crate::W<ARB_RW7_RA_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ra(&mut self) -> RA_W<ARB_RW7_RA_SPEC> {
        RA_W::new(self, 0)
    }
...
#[doc = "Endpoint Read Address value *1\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`arb_rw7_ra::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`arb_rw7_ra::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
