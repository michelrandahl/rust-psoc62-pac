...
pub type R = crate::R<DMA_THRES16_SPEC>;
#[doc = "Register `DMA_THRES16` writer"]
pub type W = crate::W<DMA_THRES16_SPEC>;
...
pub type DMA_THS16_W<'a, REG> = crate::FieldWriter<'a, REG, 9, u16>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dma_ths16(&mut self) -> DMA_THS16_W<DMA_THRES16_SPEC> {
        DMA_THS16_W::new(self, 0)
    }
