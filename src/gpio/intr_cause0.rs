...
pub type R = crate::R<INTR_CAUSE0_SPEC>;
...
#[doc = "Interrupt port cause register 0\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`intr_cause0::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
