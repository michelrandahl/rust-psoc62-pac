...
pub type R = crate::R<INTR_USBHOST_CAUSE_LO_SPEC>;
...
#[doc = "Interrupt USB Host Cause Low Register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`intr_usbhost_cause_lo::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
