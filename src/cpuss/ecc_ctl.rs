...
#[doc = "Field `WORD_ADDR` reader - Specifies the word address where an error will be injected. - On a write transfer to this SRAM address and when the corresponding RAM0/RAM1/RAM2/CM0/CM4_PWR_CTL_CTL.ECC_INJ_EN bit is '1', the parity (PARITY) is injected."]
pub type WORD_ADDR_R = crate::FieldReader<u32>;
#[doc = "Field `WORD_ADDR` writer - Specifies the word address where an error will be injected. - On a write transfer to this SRAM address and when the corresponding RAM0/RAM1/RAM2/CM0/CM4_PWR_CTL_CTL.ECC_INJ_EN bit is '1', the parity (PARITY) is injected."]
pub type WORD_ADDR_W<'a, REG> = crate::FieldWriter<'a, REG, 25, u32>;
...
impl R {
    #[doc = "Bits 0:24 - Specifies the word address where an error will be injected. - On a write transfer to this SRAM address and when the corresponding RAM0/RAM1/RAM2/CM0/CM4_PWR_CTL_CTL.ECC_INJ_EN bit is '1', the parity (PARITY) is injected."]
    #[inline(always)]
