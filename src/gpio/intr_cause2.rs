...
pub type R = crate::R<INTR_CAUSE2_SPEC>;
...
#[doc = "Interrupt port cause register 2\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`intr_cause2::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
