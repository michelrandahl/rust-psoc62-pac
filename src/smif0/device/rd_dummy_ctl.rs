...
pub type R = crate::R<RD_DUMMY_CTL_SPEC>;
#[doc = "Register `RD_DUMMY_CTL` writer"]
pub type W = crate::W<RD_DUMMY_CTL_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn size5(&mut self) -> SIZE5_W<RD_DUMMY_CTL_SPEC> {
        SIZE5_W::new(self, 0)
    }
    #[doc = "Bit 31 - Presence of dummy cycles: '0': not present '1': present"]
    #[inline(always)]
    #[must_use]
    pub fn present(&mut self) -> PRESENT_W<RD_DUMMY_CTL_SPEC> {
...
#[doc = "Read dummy control\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`rd_dummy_ctl::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`rd_dummy_ctl::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
