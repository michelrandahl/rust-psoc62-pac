...
pub type R = crate::R<INTR_HOST_EP_CAUSE_MED_SPEC>;
...
#[doc = "Interrupt USB Host Endpoint Cause Medium Register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`intr_host_ep_cause_med::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
