...
pub type R = crate::R<CAPABILITIES1_R_SPEC>;
...
#[doc = "Capabilities 1 Register - 0 to 31\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`capabilities1_r::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
