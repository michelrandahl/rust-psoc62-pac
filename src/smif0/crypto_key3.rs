...
pub type W = crate::W<CRYPTO_KEY3_SPEC>;
...
= CRYPTO_KEY3.KEY\\[31:0\\]."]
    #[inline(always)]
    #[must_use]
    pub fn key(&mut self) -> KEY_W<CRYPTO_KEY3_SPEC> {
        KEY_W::new(self, 0)
    }
...
#[doc = "Cryptography key 3\n\nYou can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`crypto_key3::W`](W). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
