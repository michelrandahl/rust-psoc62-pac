...
pub type R = crate::R<ARB_RW1_DR_SPEC>;
#[doc = "Register `ARB_RW1_DR` writer"]
pub type W = crate::W<ARB_RW1_DR_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dr(&mut self) -> DR_W<ARB_RW1_DR_SPEC> {
        DR_W::new(self, 0)
    }
...
#[doc = "Endpoint Data Register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`arb_rw1_dr::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`arb_rw1_dr::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
