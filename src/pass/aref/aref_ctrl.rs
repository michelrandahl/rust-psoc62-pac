...
pub type R = crate::R<AREF_CTRL_SPEC>;
#[doc = "Register `AREF_CTRL` writer"]
pub type W = crate::W<AREF_CTRL_SPEC>;
...
impl AREF_MODE_R {
    ...
    #[inline(always)]
    pub const fn variant(&self) -> AREF_MODE_A {
        match self.bits {
...
pub type AREF_MODE_W<'a, REG> = crate::BitWriter<'a, REG, AREF_MODE_A>;
impl<'a, REG> AREF_MODE_W<'a, REG>
where
...
pub type AREF_BIAS_SCALE_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
...
pub type AREF_RMB_W<'a, REG> = crate::FieldWriter<'a, REG, 3>;
...
pub type CTB_IPTAT_SCALE_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type CTB_IPTAT_REDIRECT_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
...
impl IZTAT_SEL_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> IZTAT_SEL_A {
        match self.bits {
...
pub type IZTAT_SEL_W<'a, REG> = crate::BitWriter<'a, REG, IZTAT_SEL_A>;
impl<'a, REG> IZTAT_SEL_W<'a, REG>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    #[doc = "Use 250nA IZTAT from SRSS"]
...
pub type CLOCK_PUMP_PERI_SEL_W<'a, REG> = crate::BitWriter<'a, REG>;
...
impl VREF_SEL_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> Option<VREF_SEL_A> {
        match self.bits {
...
pub type VREF_SEL_W<'a, REG> = crate::FieldWriter<'a, REG, 2, VREF_SEL_A>;
...
impl DEEPSLEEP_MODE_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> DEEPSLEEP_MODE_A {
        match self.bits {
...
pub type DEEPSLEEP_MODE_W<'a, REG> = crate::FieldWriterSafe<'a, REG, 2, DEEPSLEEP_MODE_A>;
impl<'a, REG> DEEPSLEEP_MODE_W<'a, REG>
where
    REG: crate::Writable + crate::RegisterSpec,
    REG::Ux: From<u8>,
{
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn aref_mode(&mut self) -> AREF_MODE_W<AREF_CTRL_SPEC> {
        AREF_MODE_W::new(self, 0)
    }
    #[doc = "Bits 2:3 - BIAS Current Control for all AREF Amplifiers. (These are risk mitigation bits that should not be touched by the customer: the impact on IDDA/noise/startup still needs to be characterized) 0: 125nA (reduced bias: reduction in total AREF IDDA, higher noise and longer startup times) 1: 250nA ('default' setting to meet bandgap performance (noise/startup) and IDDA specifications) 2: 375nA (increased bias: increase in total AREF IDDA, lower noise and shorter startup times) 3: 500nA (further increased bias: increase in total AREF IDDA, lower noise and shorter startup times)"]
    #[inline(always)]
    #[must_use]
    pub fn aref_bias_scale(&mut self) -> AREF_BIAS_SCALE_W<AREF_CTRL_SPEC> {
        AREF_BIAS_SCALE_W::new(self, 2)
    }
    #[doc = "Bits 4:6 - AREF control signals (RMB). Bit 0: Manual VBG startup circuit enable 0: normal VBG startup circuit operation 1: VBG startup circuit is forced 'always on' Bit 1: Manual disable of IPTAT2 DAC 0: normal IPTAT2 DAC operation 1: PTAT2 DAC is disabled while VBG startup is active Bit 2: Manual enable of VBG offset correction DAC 0: normal VBG offset correction DAC operation 1: VBG offset correction DAC is enabled while VBG startup is active"]
    #[inline(always)]
    #[must_use]
    pub fn aref_rmb(&mut self) -> AREF_RMB_W<AREF_CTRL_SPEC> {
        AREF_RMB_W::new(self, 4)
    }
    #[doc = "Bit 7 - CTB IPTAT current scaler. This bit must be set in order to operate the CTB amplifiers in the lowest power mode. This bit is chip-wide (controls all CTB amplifiers). 0: 1uA 1: 100nA"]
    #[inline(always)]
    #[must_use]
    pub fn ctb_iptat_scale(&mut self) -> CTB_IPTAT_SCALE_W<AREF_CTRL_SPEC> {
        CTB_IPTAT_SCALE_W::new(self, 7)
    }
    #[doc = "Bits 8:15 - Re-direct the CTB IPTAT output current. This can be used to reduce amplifier bias glitches during power mode transitions (for PSoC4A/B DSAB backwards compatibility). 0: Opamp&lt;n>.IPTAT = AREF.IPTAT and Opamp&lt;n>.IZTAT= AREF.IZTAT 1: Opamp&lt;n>.IPTAT = HiZ and Opamp&lt;n>.IZTAT= AREF.IPTAT *Note that in Deep Sleep, the AREF IZTAT and/or IPTAT currents can be disabled and therefore the corresponding Opamp&lt;n>.IZTAT/IPTAT will be HiZ."]
    #[inline(always)]
    #[must_use]
    pub fn ctb_iptat_redirect(&mut self) -> CTB_IPTAT_REDIRECT_W<AREF_CTRL_SPEC> {
        CTB_IPTAT_REDIRECT_W::new(self, 8)
    }
    #[doc = "Bit 16 - iztat current select control"]
    #[inline(always)]
    #[must_use]
    pub fn iztat_sel(&mut self) -> IZTAT_SEL_W<AREF_CTRL_SPEC> {
        IZTAT_SEL_W::new(self, 16)
    }
    #[doc = "Bit 19 - CTBm charge pump clock source select. This field has nothing to do with the AREF. 0: Use the dedicated pump clock from SRSS (default) 1: Use one of the CLK_PERI dividers"]
    #[inline(always)]
    #[must_use]
    pub fn clock_pump_peri_sel(&mut self) -> CLOCK_PUMP_PERI_SEL_W<AREF_CTRL_SPEC> {
        CLOCK_PUMP_PERI_SEL_W::new(self, 19)
    }
    #[doc = "Bits 20:21 - bandgap voltage select control"]
    #[inline(always)]
    #[must_use]
    pub fn vref_sel(&mut self) -> VREF_SEL_W<AREF_CTRL_SPEC> {
        VREF_SEL_W::new(self, 20)
    }
    #[doc = "Bits 28:29 - AREF DeepSleep Operation Modes (only applies if DEEPSLEEP_ON = 1)"]
    #[inline(always)]
    #[must_use]
    pub fn deepsleep_mode(&mut self) -> DEEPSLEEP_MODE_W<AREF_CTRL_SPEC> {
        DEEPSLEEP_MODE_W::new(self, 28)
    }
    #[doc = "Bit 30 - - 0: AREF IP disabled/off during DeepSleep power mode - 1: AREF IP remains enabled during DeepSleep power mode (if ENABLED=1)"]
    #[inline(always)]
    #[must_use]
    pub fn deepsleep_on(&mut self) -> DEEPSLEEP_ON_W<AREF_CTRL_SPEC> {
        DEEPSLEEP_ON_W::new(self, 30)
    }
    #[doc = "Bit 31 - Disable AREF"]
    #[inline(always)]
    #[must_use]
    pub fn enabled(&mut self) -> ENABLED_W<AREF_CTRL_SPEC> {
