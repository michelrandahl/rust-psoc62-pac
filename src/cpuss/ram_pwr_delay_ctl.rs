...
pub type R = crate::R<RAM_PWR_DELAY_CTL_SPEC>;
#[doc = "Register `RAM_PWR_DELAY_CTL` writer"]
pub type W = crate::W<RAM_PWR_DELAY_CTL_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn up(&mut self) -> UP_W<RAM_PWR_DELAY_CTL_SPEC> {
        UP_W::new(self, 0)
    }
