...
pub type R = crate::R<ACT_DESCR_X_CTL_SPEC>;
...
#[doc = "Active descriptor X loop control\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`act_descr_x_ctl::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
