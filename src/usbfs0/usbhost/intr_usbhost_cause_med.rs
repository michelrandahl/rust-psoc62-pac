...
pub type R = crate::R<INTR_USBHOST_CAUSE_MED_SPEC>;
...
#[doc = "Interrupt USB Host Cause Medium Register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`intr_usbhost_cause_med::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
