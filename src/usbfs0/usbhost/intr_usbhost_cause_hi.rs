...
pub type R = crate::R<INTR_USBHOST_CAUSE_HI_SPEC>;
...
#[doc = "Interrupt USB Host Cause High Register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`intr_usbhost_cause_hi::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
