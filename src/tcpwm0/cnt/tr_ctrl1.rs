...
pub type R = crate::R<TR_CTRL1_SPEC>;
#[doc = "Register `TR_CTRL1` writer"]
pub type W = crate::W<TR_CTRL1_SPEC>;
...
impl CAPTURE_EDGE_R {
    ...
    #[inline(always)]
    pub const fn variant(&self) -> CAPTURE_EDGE_A {
        match self.bits {
...
pub type CAPTURE_EDGE_W<'a, REG> = crate::FieldWriterSafe<'a, REG, 2, CAPTURE_EDGE_A>;
impl<'a, REG> CAPTURE_EDGE_W<'a, REG>
where
...
impl COUNT_EDGE_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> COUNT_EDGE_A {
        match self.bits {
...
pub type COUNT_EDGE_W<'a, REG> = crate::FieldWriterSafe<'a, REG, 2, COUNT_EDGE_A>;
impl<'a, REG> COUNT_EDGE_W<'a, REG>
where
    REG: crate::Writable + crate::RegisterSpec,
    REG::Ux: From<u8>,
{
...
impl RELOAD_EDGE_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> RELOAD_EDGE_A {
        match self.bits {
...
pub type RELOAD_EDGE_W<'a, REG> = crate::FieldWriterSafe<'a, REG, 2, RELOAD_EDGE_A>;
impl<'a, REG> RELOAD_EDGE_W<'a, REG>
where
    REG: crate::Writable + crate::RegisterSpec,
    REG::Ux: From<u8>,
{
...
impl STOP_EDGE_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> STOP_EDGE_A {
        match self.bits {
...
pub type STOP_EDGE_W<'a, REG> = crate::FieldWriterSafe<'a, REG, 2, STOP_EDGE_A>;
impl<'a, REG> STOP_EDGE_W<'a, REG>
where
    REG: crate::Writable + crate::RegisterSpec,
    REG::Ux: From<u8>,
{
...
impl START_EDGE_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> START_EDGE_A {
        match self.bits {
...
pub type START_EDGE_W<'a, REG> = crate::FieldWriterSafe<'a, REG, 2, START_EDGE_A>;
impl<'a, REG> START_EDGE_W<'a, REG>
where
    REG: crate::Writable + crate::RegisterSpec,
    REG::Ux: From<u8>,
{
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn capture_edge(&mut self) -> CAPTURE_EDGE_W<TR_CTRL1_SPEC> {
        CAPTURE_EDGE_W::new(self, 0)
    }
    #[doc = "Bits 2:3 - A counter event will increase or decrease the counter by '1'."]
    #[inline(always)]
    #[must_use]
    pub fn count_edge(&mut self) -> COUNT_EDGE_W<TR_CTRL1_SPEC> {
        COUNT_EDGE_W::new(self, 2)
    }
    #[doc = "Bits 4:5 - A reload event will initialize the counter. When counting up, the counter is initialized to '0'. When counting down, the counter is initialized with PERIOD."]
    #[inline(always)]
    #[must_use]
    pub fn reload_edge(&mut self) -> RELOAD_EDGE_W<TR_CTRL1_SPEC> {
        RELOAD_EDGE_W::new(self, 4)
    }
    #[doc = "Bits 6:7 - A stop event, will stop the counter; i.e. it will no longer be running. Stopping will NOT disable the counter."]
    #[inline(always)]
    #[must_use]
    pub fn stop_edge(&mut self) -> STOP_EDGE_W<TR_CTRL1_SPEC> {
        STOP_EDGE_W::new(self, 6)
    }
    #[doc = "Bits 8:9 - A start event will start the counter; i.e. the counter will become running. Starting does NOT enable the counter. A start event will not initialize the counter whereas the reload event does."]
    #[inline(always)]
    #[must_use]
    pub fn start_edge(&mut self) -> START_EDGE_W<TR_CTRL1_SPEC> {
        START_EDGE_W::new(self, 8)
    }
...
#[doc = "Counter trigger control register 1\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`tr_ctrl1::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`tr_ctrl1::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
