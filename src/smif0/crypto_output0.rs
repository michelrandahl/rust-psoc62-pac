...
pub type R = crate::R<CRYPTO_OUTPUT0_SPEC>;
#[doc = "Register `CRYPTO_OUTPUT0` writer"]
pub type W = crate::W<CRYPTO_OUTPUT0_SPEC>;
...
= CRYPTO_OUTPUT0.OUTPUT\\[31:0\\]."]
    #[inline(always)]
    #[must_use]
    pub fn output(&mut self) -> OUTPUT_W<CRYPTO_OUTPUT0_SPEC> {
        OUTPUT_W::new(self, 0)
    }
...
#[doc = "Cryptography output 0\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`crypto_output0::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`crypto_output0::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
