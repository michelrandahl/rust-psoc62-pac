...
pub type R = crate::R<ARB_RW8_RA16_SPEC>;
#[doc = "Register `ARB_RW8_RA16` writer"]
pub type W = crate::W<ARB_RW8_RA16_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ra16(&mut self) -> RA16_W<ARB_RW8_RA16_SPEC> {
        RA16_W::new(self, 0)
    }
