...
pub type R = crate::R<RTC_TIME_SPEC>;
#[doc = "Register `RTC_TIME` writer"]
pub type W = crate::W<RTC_TIME_SPEC>;
...
pub type RTC_SEC_W<'a, REG> = crate::FieldWriter<'a, REG, 7>;
...
pub type RTC_MIN_W<'a, REG> = crate::FieldWriter<'a, REG, 7>;
...
pub type RTC_HOUR_W<'a, REG> = crate::FieldWriter<'a, REG, 6>;
...
pub type CTRL_12HR_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type RTC_DAY_W<'a, REG> = crate::FieldWriter<'a, REG, 3>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn rtc_sec(&mut self) -> RTC_SEC_W<RTC_TIME_SPEC> {
        RTC_SEC_W::new(self, 0)
    }
    #[doc = "Bits 8:14 - Calendar minutes in BCD, 0-59"]
    #[inline(always)]
    #[must_use]
    pub fn rtc_min(&mut self) -> RTC_MIN_W<RTC_TIME_SPEC> {
        RTC_MIN_W::new(self, 8)
    }
    #[doc = "Bits 16:21 - Calendar hours in BCD, value depending on 12/24HR mode 0=24HR: \\[21:16\\]=0-23 1=12HR: \\[21\\]:0=AM, 1=PM, \\[20:16\\]=1-12"]
    #[inline(always)]
    #[must_use]
    pub fn rtc_hour(&mut self) -> RTC_HOUR_W<RTC_TIME_SPEC> {
        RTC_HOUR_W::new(self, 16)
    }
    #[doc = "Bit 22 - Select 12/24HR mode: 1=12HR, 0=24HR"]
    #[inline(always)]
    #[must_use]
    pub fn ctrl_12hr(&mut self) -> CTRL_12HR_W<RTC_TIME_SPEC> {
        CTRL_12HR_W::new(self, 22)
    }
    #[doc = "Bits 24:26 - Calendar Day of the week in BCD, 1-7 It is up to the user to define the meaning of the values, but 1=Monday is recommended"]
    #[inline(always)]
    #[must_use]
    pub fn rtc_day(&mut self) -> RTC_DAY_W<RTC_TIME_SPEC> {
        RTC_DAY_W::new(self, 24)
    }
