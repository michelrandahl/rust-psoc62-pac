...
pub type R = crate::R<TRIM_RAM_CTL_SPEC>;
#[doc = "Register `TRIM_RAM_CTL` writer"]
pub type W = crate::W<TRIM_RAM_CTL_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn trim(&mut self) -> TRIM_W<TRIM_RAM_CTL_SPEC> {
        TRIM_W::new(self, 0)
    }
...
#[doc = "RAM trim control\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`trim_ram_ctl::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`trim_ram_ctl::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
