...
pub type R = crate::R<RX_DATA_FIFO_STATUS_SPEC>;
...
#[doc = "Receiver data FIFO status\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`rx_data_fifo_status::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
