...
pub type R = crate::R<ARB_RW8_WA_SPEC>;
#[doc = "Register `ARB_RW8_WA` writer"]
pub type W = crate::W<ARB_RW8_WA_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn wa(&mut self) -> WA_W<ARB_RW8_WA_SPEC> {
        WA_W::new(self, 0)
    }
...
#[doc = "Endpoint Write Address value *1\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`arb_rw8_wa::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`arb_rw8_wa::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
