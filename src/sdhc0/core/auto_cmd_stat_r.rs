...
pub type R = crate::R<AUTO_CMD_STAT_R_SPEC>;
...
#[doc = "Auto CMD Status Register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`auto_cmd_stat_r::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
