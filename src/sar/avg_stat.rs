...
pub type R = crate::R<AVG_STAT_SPEC>;
...
#[doc = "Current averaging status (for debug)\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`avg_stat::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
