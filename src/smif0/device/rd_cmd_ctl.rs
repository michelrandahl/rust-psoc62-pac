...
pub type R = crate::R<RD_CMD_CTL_SPEC>;
#[doc = "Register `RD_CMD_CTL` writer"]
pub type W = crate::W<RD_CMD_CTL_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn code(&mut self) -> CODE_W<RD_CMD_CTL_SPEC> {
        CODE_W::new(self, 0)
    }
    #[doc = "Bits 16:17 - Width of data transfer: '0': 1 bit/cycle (single data transfer). '1': 2 bits/cycle (dual data transfer). '2': 4 bits/cycle (quad data transfer). '3': 8 bits/cycle (octal data transfer)."]
    #[inline(always)]
    #[must_use]
    pub fn width(&mut self) -> WIDTH_W<RD_CMD_CTL_SPEC> {
        WIDTH_W::new(self, 16)
    }
    #[doc = "Bit 31 - Presence of command field: '0': not present '1': present"]
    #[inline(always)]
    #[must_use]
    pub fn present(&mut self) -> PRESENT_W<RD_CMD_CTL_SPEC> {
