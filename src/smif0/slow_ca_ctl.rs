...
pub type R = crate::R<SLOW_CA_CTL_SPEC>;
#[doc = "Register `SLOW_CA_CTL` writer"]
pub type W = crate::W<SLOW_CA_CTL_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn way(&mut self) -> WAY_W<SLOW_CA_CTL_SPEC> {
        WAY_W::new(self, 16)
    }
    #[doc = "Bits 24:25 - this is for debug purpose only, and should be hidden to customers in technical document"]
    #[inline(always)]
    #[must_use]
    pub fn set_addr(&mut self) -> SET_ADDR_W<SLOW_CA_CTL_SPEC> {
        SET_ADDR_W::new(self, 24)
    }
    #[doc = "Bit 30 - N/A"]
    #[inline(always)]
    #[must_use]
    pub fn pref_en(&mut self) -> PREF_EN_W<SLOW_CA_CTL_SPEC> {
        PREF_EN_W::new(self, 30)
    }
    #[doc = "Bit 31 - N/A"]
    #[inline(always)]
    #[must_use]
    pub fn enabled(&mut self) -> ENABLED_W<SLOW_CA_CTL_SPEC> {
...
#[doc = "Slow cache control\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`slow_ca_ctl::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`slow_ca_ctl::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
