...
pub type R = crate::R<INTR_S_MASKED_SPEC>;
...
#[doc = "Slave interrupt masked request\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`intr_s_masked::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
