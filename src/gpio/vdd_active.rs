...
pub type R = crate::R<VDD_ACTIVE_SPEC>;
...
#[doc = "Extern power supply detection register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`vdd_active::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
