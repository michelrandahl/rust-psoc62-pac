...
pub type R = crate::R<ACT_DESCR_CTL_SPEC>;
...
#[doc = "Active descriptor control\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`act_descr_ctl::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
