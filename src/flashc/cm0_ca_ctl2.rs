...
pub type R = crate::R<CM0_CA_CTL2_SPEC>;
#[doc = "Register `CM0_CA_CTL2` writer"]
pub type W = crate::W<CM0_CA_CTL2_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pwrup_delay(&mut self) -> PWRUP_DELAY_W<CM0_CA_CTL2_SPEC> {
...
#[doc = "CM0+ cache control\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`cm0_ca_ctl2::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`cm0_ca_ctl2::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
