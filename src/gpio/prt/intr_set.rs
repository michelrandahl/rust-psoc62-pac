...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn edge0(&mut self) -> EDGE0_W<INTR_SET_SPEC> {
        EDGE0_W::new(self, 0)
    }
    #[doc = "Bit 1 - Sets edge detect interrupt for IO pin 1"]
    #[inline(always)]
    #[must_use]
    pub fn edge1(&mut self) -> EDGE1_W<INTR_SET_SPEC> {
        EDGE1_W::new(self, 1)
    }
    #[doc = "Bit 2 - Sets edge detect interrupt for IO pin 2"]
    #[inline(always)]
    #[must_use]
    pub fn edge2(&mut self) -> EDGE2_W<INTR_SET_SPEC> {
        EDGE2_W::new(self, 2)
    }
    #[doc = "Bit 3 - Sets edge detect interrupt for IO pin 3"]
    #[inline(always)]
    #[must_use]
    pub fn edge3(&mut self) -> EDGE3_W<INTR_SET_SPEC> {
        EDGE3_W::new(self, 3)
    }
    #[doc = "Bit 4 - Sets edge detect interrupt for IO pin 4"]
    #[inline(always)]
    #[must_use]
    pub fn edge4(&mut self) -> EDGE4_W<INTR_SET_SPEC> {
        EDGE4_W::new(self, 4)
    }
    #[doc = "Bit 5 - Sets edge detect interrupt for IO pin 5"]
    #[inline(always)]
    #[must_use]
    pub fn edge5(&mut self) -> EDGE5_W<INTR_SET_SPEC> {
        EDGE5_W::new(self, 5)
    }
    #[doc = "Bit 6 - Sets edge detect interrupt for IO pin 6"]
    #[inline(always)]
    #[must_use]
    pub fn edge6(&mut self) -> EDGE6_W<INTR_SET_SPEC> {
        EDGE6_W::new(self, 6)
    }
    #[doc = "Bit 7 - Sets edge detect interrupt for IO pin 7"]
    #[inline(always)]
    #[must_use]
    pub fn edge7(&mut self) -> EDGE7_W<INTR_SET_SPEC> {
        EDGE7_W::new(self, 7)
    }
    #[doc = "Bit 8 - Sets edge detect interrupt for filtered pin selected by INTR_CFG.FLT_SEL"]
    #[inline(always)]
    #[must_use]
    pub fn flt_edge(&mut self) -> FLT_EDGE_W<INTR_SET_SPEC> {
