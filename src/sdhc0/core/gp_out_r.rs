...
pub type R = crate::R<GP_OUT_R_SPEC>;
#[doc = "Register `GP_OUT_R` writer"]
pub type W = crate::W<GP_OUT_R_SPEC>;
...
pub type CARD_DETECT_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type CARD_MECH_WRITE_PROT_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type LED_CTRL_OE_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type CARD_CLOCK_OE_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type CARD_IF_PWR_EN_OE_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type IO_VOLT_SEL_OE_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type CARD_CLOCK_OUT_DLY_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
...
pub type CARD_CLOCK_IN_DLY_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn card_detect_en(&mut self) -> CARD_DETECT_EN_W<GP_OUT_R_SPEC> {
        CARD_DETECT_EN_W::new(self, 0)
    }
    #[doc = "Bit 1 - card_mech_write_prot, despite its name, is an active low signal (per the SD Host Controller Standard spec it is officially called SDWP#). Consider that in the following: 0: Force card_mech_write_prot input to 0 internally; this forces write protection to be active 1: Allow card_mech_write_prot to work normally per the device's pin state"]
    #[inline(always)]
    #[must_use]
    pub fn card_mech_write_prot_en(&mut self) -> CARD_MECH_WRITE_PROT_EN_W<GP_OUT_R_SPEC> {
        CARD_MECH_WRITE_PROT_EN_W::new(self, 1)
    }
    #[doc = "Bit 2 - Active high output enable for the LED output signal (led_ctrl) controlled through HOST_CTRL1_R.LED_CTRL: 0: disable OE associated with the led_ctrl output 1: enable OE associated with the led_ctrl output"]
    #[inline(always)]
    #[must_use]
    pub fn led_ctrl_oe(&mut self) -> LED_CTRL_OE_W<GP_OUT_R_SPEC> {
        LED_CTRL_OE_W::new(self, 2)
    }
    #[doc = "Bit 3 - Active high output enable for the card clock output (clk_card) which is gated by CLK_CTRL_R.SD_CLK_EN: 0: disable OE to the clk_card output 1: enable OE to the clk_card output"]
    #[inline(always)]
    #[must_use]
    pub fn card_clock_oe(&mut self) -> CARD_CLOCK_OE_W<GP_OUT_R_SPEC> {
        CARD_CLOCK_OE_W::new(self, 3)
    }
    #[doc = "Bit 4 - Active high output enable for the card interface power enable output (card_if_pwr_en) controlled through PWR_CTRL_R.SD_BUS_PWR_VDD1: 0: disable OE to the card_if_pwr_en output 1: enable OE to the card_if_pwr_en output"]
    #[inline(always)]
    #[must_use]
    pub fn card_if_pwr_en_oe(&mut self) -> CARD_IF_PWR_EN_OE_W<GP_OUT_R_SPEC> {
        CARD_IF_PWR_EN_OE_W::new(self, 4)
    }
    #[doc = "Bit 5 - Active high output enable for the IO voltage selection signal (io_volt_sel) controlled through HOST_CTRL_2.SIGNALING_EN: 0: disable OE to the io_volt_sel output 1: enable OE to the io_volt_sel output"]
    #[inline(always)]
    #[must_use]
    pub fn io_volt_sel_oe(&mut self) -> IO_VOLT_SEL_OE_W<GP_OUT_R_SPEC> {
        IO_VOLT_SEL_OE_W::new(self, 5)
    }
    #[doc = "Bits 6:7 - N/A"]
    #[inline(always)]
    #[must_use]
    pub fn card_clock_out_dly(&mut self) -> CARD_CLOCK_OUT_DLY_W<GP_OUT_R_SPEC> {
        CARD_CLOCK_OUT_DLY_W::new(self, 6)
    }
    #[doc = "Bits 8:9 - Delay CARD_CLOCK input internally to optimally sample CMD/DAT; set according to interface mode: 00: SD Default Speed, SD SDR12, eMMC Legacy 01: SD SDR25, SD SDR50 10: SD High Speed, eMMC High Speed SDR 11: SD DDR50, eMMC DDR"]
    #[inline(always)]
    #[must_use]
    pub fn card_clock_in_dly(&mut self) -> CARD_CLOCK_IN_DLY_W<GP_OUT_R_SPEC> {
        CARD_CLOCK_IN_DLY_W::new(self, 8)
    }
