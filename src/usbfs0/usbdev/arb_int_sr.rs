...
pub type R = crate::R<ARB_INT_SR_SPEC>;
...
#[doc = "Arbiter Interrupt Status *1\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`arb_int_sr::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
