...
pub type R = crate::R<ERROR_INT_SIGNAL_EN_R_SPEC>;
#[doc = "Register `ERROR_INT_SIGNAL_EN_R` writer"]
pub type W = crate::W<ERROR_INT_SIGNAL_EN_R_SPEC>;
...
pub type CMD_TOUT_ERR_SIGNAL_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type CMD_CRC_ERR_SIGNAL_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type CMD_END_BIT_ERR_SIGNAL_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type CMD_IDX_ERR_SIGNAL_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type DATA_TOUT_ERR_SIGNAL_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type DATA_CRC_ERR_SIGNAL_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type DATA_END_BIT_ERR_SIGNAL_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type CUR_LMT_ERR_SIGNAL_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type AUTO_CMD_ERR_SIGNAL_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type ADMA_ERR_SIGNAL_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type TUNING_ERR_SIGNAL_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type RESP_ERR_SIGNAL_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type BOOT_ACK_ERR_SIGNAL_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type VENDOR_ERR_SIGNAL_EN1_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type VENDOR_ERR_SIGNAL_EN2_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type VENDOR_ERR_SIGNAL_EN3_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
...
impl W {
    ...
    pub fn cmd_tout_err_signal_en(
        &mut self,
    ) -> CMD_TOUT_ERR_SIGNAL_EN_W<ERROR_INT_SIGNAL_EN_R_SPEC> {
        CMD_TOUT_ERR_SIGNAL_EN_W::new(self, 0)
    }
    #[doc = "Bit 1 - Command CRC Error Signal Enable (SD/eMMC Mode only) Values: - 0x0 (FALSE): Masked - 0x1 (TRUE): Enabled"]
    #[inline(always)]
    #[must_use]
    pub fn cmd_crc_err_signal_en(&mut self) -> CMD_CRC_ERR_SIGNAL_EN_W<ERROR_INT_SIGNAL_EN_R_SPEC> {
        CMD_CRC_ERR_SIGNAL_EN_W::new(self, 1)
    }
    #[doc = "Bit 2 - Command End Bit Error Signal Enable (SD/eMMC Mode only) Values: - 0x0 (FALSE): Masked - 0x1 (TRUE): Enabled"]
    #[inline(always)]
    #[must_use]
    pub fn cmd_end_bit_err_signal_en(
        &mut self,
    ) -> CMD_END_BIT_ERR_SIGNAL_EN_W<ERROR_INT_SIGNAL_EN_R_SPEC> {
        CMD_END_BIT_ERR_SIGNAL_EN_W::new(self, 2)
    }
    #[doc = "Bit 3 - Command Index Error Signal Enable (SD/eMMC Mode only) Values: - 0x0 (FALSE): No error - 0x1 (TRUE): Error"]
    #[inline(always)]
    #[must_use]
    pub fn cmd_idx_err_signal_en(&mut self) -> CMD_IDX_ERR_SIGNAL_EN_W<ERROR_INT_SIGNAL_EN_R_SPEC> {
        CMD_IDX_ERR_SIGNAL_EN_W::new(self, 3)
    }
    #[doc = "Bit 4 - Data Timeout Error Signal Enable (SD/eMMC Mode only) Values: - 0x0 (FALSE): Masked - 0x1 (TRUE): Enabled"]
    #[inline(always)]
    #[must_use]
    pub fn data_tout_err_signal_en(
        &mut self,
    ) -> DATA_TOUT_ERR_SIGNAL_EN_W<ERROR_INT_SIGNAL_EN_R_SPEC> {
        DATA_TOUT_ERR_SIGNAL_EN_W::new(self, 4)
    }
    #[doc = "Bit 5 - Data CRC Error Signal Enable (SD/eMMC Mode only) Values: - 0x0 (FALSE): Masked - 0x1 (TRUE): Enabled"]
    #[inline(always)]
    #[must_use]
    pub fn data_crc_err_signal_en(
        &mut self,
    ) -> DATA_CRC_ERR_SIGNAL_EN_W<ERROR_INT_SIGNAL_EN_R_SPEC> {
        DATA_CRC_ERR_SIGNAL_EN_W::new(self, 5)
    }
    #[doc = "Bit 6 - Data End Bit Error Signal Enable (SD/eMMC Mode only) Values: - 0x0 (FALSE): Masked - 0x1 (TRUE): Enabled"]
    #[inline(always)]
    #[must_use]
    pub fn data_end_bit_err_signal_en(
        &mut self,
    ) -> DATA_END_BIT_ERR_SIGNAL_EN_W<ERROR_INT_SIGNAL_EN_R_SPEC> {
        DATA_END_BIT_ERR_SIGNAL_EN_W::new(self, 6)
    }
    #[doc = "Bit 7 - Current Limit Error Signal Enable Values: - 0x0 (FALSE): Masked - 0x1 (TRUE): Enabled"]
    #[inline(always)]
    #[must_use]
    pub fn cur_lmt_err_signal_en(&mut self) -> CUR_LMT_ERR_SIGNAL_EN_W<ERROR_INT_SIGNAL_EN_R_SPEC> {
        CUR_LMT_ERR_SIGNAL_EN_W::new(self, 7)
    }
    #[doc = "Bit 8 - Auto CMD Error Signal Enable (SD/eMMC Mode only) Values: - 0x0 (FALSE): Masked - 0x1 (TRUE): Enabled"]
    #[inline(always)]
    #[must_use]
    pub fn auto_cmd_err_signal_en(
        &mut self,
    ) -> AUTO_CMD_ERR_SIGNAL_EN_W<ERROR_INT_SIGNAL_EN_R_SPEC> {
        AUTO_CMD_ERR_SIGNAL_EN_W::new(self, 8)
    }
    #[doc = "Bit 9 - ADMA Error Signal Enable Values: - 0x0 (FALSE): Masked - 0x1 (TRUE): Enabled"]
    #[inline(always)]
    #[must_use]
    pub fn adma_err_signal_en(&mut self) -> ADMA_ERR_SIGNAL_EN_W<ERROR_INT_SIGNAL_EN_R_SPEC> {
        ADMA_ERR_SIGNAL_EN_W::new(self, 9)
    }
    #[doc = "Bit 10 - N/A"]
    #[inline(always)]
    #[must_use]
    pub fn tuning_err_signal_en(&mut self) -> TUNING_ERR_SIGNAL_EN_W<ERROR_INT_SIGNAL_EN_R_SPEC> {
        TUNING_ERR_SIGNAL_EN_W::new(self, 10)
    }
    #[doc = "Bit 11 - Response Error Signal Enable (SD Mode only) Values: - 0x0 (FALSE): Masked - 0x1 (TRUE): Enabled"]
    #[inline(always)]
    #[must_use]
    pub fn resp_err_signal_en(&mut self) -> RESP_ERR_SIGNAL_EN_W<ERROR_INT_SIGNAL_EN_R_SPEC> {
        RESP_ERR_SIGNAL_EN_W::new(self, 11)
    }
    #[doc = "Bit 12 - Boot Acknowledgment Error (eMMC Mode only). Setting this bit to 1 enables generating interrupt signal when Boot Acknowledgement Error in Error Interrupt Status register is set. Values: - 0x0 (FALSE): Masked - 0x1 (TRUE): Enabled"]
    #[inline(always)]
    #[must_use]
    pub fn boot_ack_err_signal_en(
        &mut self,
    ) -> BOOT_ACK_ERR_SIGNAL_EN_W<ERROR_INT_SIGNAL_EN_R_SPEC> {
        BOOT_ACK_ERR_SIGNAL_EN_W::new(self, 12)
    }
    #[doc = "Bit 13 - N/A"]
    #[inline(always)]
    #[must_use]
    pub fn vendor_err_signal_en1(&mut self) -> VENDOR_ERR_SIGNAL_EN1_W<ERROR_INT_SIGNAL_EN_R_SPEC> {
        VENDOR_ERR_SIGNAL_EN1_W::new(self, 13)
    }
    #[doc = "Bit 14 - N/A"]
    #[inline(always)]
    #[must_use]
    pub fn vendor_err_signal_en2(&mut self) -> VENDOR_ERR_SIGNAL_EN2_W<ERROR_INT_SIGNAL_EN_R_SPEC> {
        VENDOR_ERR_SIGNAL_EN2_W::new(self, 14)
    }
    #[doc = "Bit 15 - N/A"]
    #[inline(always)]
    #[must_use]
    pub fn vendor_err_signal_en3(&mut self) -> VENDOR_ERR_SIGNAL_EN3_W<ERROR_INT_SIGNAL_EN_R_SPEC> {
        VENDOR_ERR_SIGNAL_EN3_W::new(self, 15)
    }
